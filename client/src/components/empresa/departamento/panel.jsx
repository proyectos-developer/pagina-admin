...
import NuevoDepartamento from './menu/nuevodepartamento.jsx'
import UpdateDepartamento from './menu/updatedepartamento.jsx'
...
export default function DepartamentosEmpresaPanel ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_departamento_guardado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevoDepartamento proporcional={proporcional} departamento={departamento}/>
            ...
            }
            {
                show_departamento_actualizado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '30%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateDepartamento proporcional={proporcional} departamento={departamento}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
