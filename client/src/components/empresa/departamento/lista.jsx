...
import CardDepartamento from './card/departamento.jsx'
...
export default function ListaDepartamentosEmpresa ({proporcional}) {
                ...
                lista_grid_departamentos && lista_grid_departamentos.length > 0 && view_departamento === 'grid' ? (
                    lista_grid_departamentos.map ((departamento, numdep) => {
                        return (
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    departamentos [(4 * numdep)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardDepartamento departamento={departamentos[(4 * numdep)]} key={(4 * numdep)} index={(4 * numdep)} proporcional={proporcional} view_departamento={view_departamento}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    departamentos [((4 * numdep) + 1)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardDepartamento departamento={departamentos[((4 * numdep) + 1)]} key={((4 * numdep) + 1)} index={((4 * numdep) + 1)} proporcional={proporcional} view_departamento={view_departamento}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    departamentos [((4 * numdep) + 2)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardDepartamento departamento={departamentos[((4 * numdep) + 2)]} key={((4 * numdep) + 2)} index={((4 * numdep) + 2)} proporcional={proporcional} view_departamento={view_departamento}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    departamentos [((4 * numdep) + 3)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardDepartamento departamento={departamentos[((4 * numdep) + 3)]} key={((4 * numdep) + 3)} index={((4 * numdep) + 3)} proporcional={proporcional} view_departamento={view_departamento}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                    ...
                    lista_departamentos && lista_departamentos.length > 0 && view_departamento === 'lista' ? (
                        lista_departamentos.map ((departamento, numdep) => {
                            return (
                                <CardDepartamento departamento={departamento} key={numdep} index={numdep} proporcional={proporcional} view_departamento={view_departamento}/>
                            )
                        })
                ) : null
            }                  
