        ...
        <div key={index} className='rounded' style={{width: '100%', height: '100%', 
            ...
            <div style={{width: '100%', height: 'auto', padding: 10 / proporcional, cursor: 'pointer'}}
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 40 / proporcional}}>
                    <div className='' style={{width: '70%', height: 40 / proporcional}}>
                    ...
                    <div className='d-flex justify-content-between' style={{width: '30%', height: 40 / proporcional}}>
                        <div className='d-flex justify-content-center' style={{width: '13%', height: 30 / proporcional}}>
