...
export default function ListaDepartamentosCell ({proporcional}) {
    ...
    return (
        <div className='position-relative' style={{width: '100%', paddingTop: 40 / proporcional, paddingBottom : 40 / proporcional}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 70 / proporcional,
                ...
                <div className='d-flex justify-content-end' style={{width: '30%', height: 70 / proporcional}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 70 / proporcional}}>
                        <p style={{fontSize: 14 / proporcional, lineHeight: `${70 / proporcional}px`, marginBottom: 0 / proporcional, 
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_departamentos && lista_departamentos.length > 0 ? (
                        lista_departamentos.map ((departamento, index) => {
                            return (
                                <CardDepartamentoCell proporcional={proporcional} key={index} index={index} departamento={departamento}/>
                            )
                        })
                    ) : null
                }
