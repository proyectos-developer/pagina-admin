...
export default function NuevoDepartamento({proporcional, departamento}) {
        ...
        <div className='' style={{width: '100%', height: 'auto'}}>
            ...
            <div className='' style={{width: '100%', height: 'auto', padding: 10 / proporcional }}>
                <h2 style={{fontSize: 16 / proporcional, lineHeight: `${30 / proporcional}px`, fontWeight: 500, marginBottom: 0,
                    fontFamily: 'Poppins, sans-serif', color: '#4a4a4a'}}>Se ha guardado la información de <strong style={{color: '#007bff'}}>({departamento.departamento})</strong>
                </h2>
            </div>
        </div>
    )
