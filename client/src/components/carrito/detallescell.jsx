...
export default function DetallesCompraCell({proporcional}) {
  ...
  const dividir_nro_columnas = (productos_data) => {
      ...
      setListaGridProductos (productos_data.productos_compra)
                    ...
                    return (
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                            <div style={{width: '90%', height: 'auto'}}>
                                <CardProductoCell producto={producto} key={numprod} index={numprod} proporcional={proporcional} view_compra={view_compra}/>
                            </div>
                        </div>
                    )
                })
