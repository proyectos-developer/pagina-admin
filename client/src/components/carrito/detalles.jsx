        ...
        <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
            <div style={{width: '68%', height: 'auto'}}>
                <h2 style={{fontSize: 28 / proporcional, lineHeight: `${30 / proporcional}px`, fontWeight: 500, marginBottom: 0,
                    color: '#4A4A4A'}}>Comprado del <strong>{(new Date(fecha_compra)).toDateString()}</strong>
                        ...
                        <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                            {
                                compras [(4 * numprod)] ? (
                                    <div style={{width: '24%', height: 'auto'}}>
                                        <CardProducto producto={compras[(4 * numprod)]} key={(4 * numprod)} index={(4 * numprod)} proporcional={proporcional} view_producto={view_producto}/>
                                    </div>
                                ) : (
                                    <div style={{width: '24%', height: 'auto'}}/>
                                )
                            }
                            {
                                compras [((4 * numprod) + 1)] ? (
                                    <div style={{width: '24%', height: 'auto'}}>
                                        <CardProducto producto={compras[((4 * numprod) + 1)]} key={((4 * numprod) + 1)} index={((4 * numprod) + 1)} proporcional={proporcional} view_producto={view_producto}/>
                                    </div>
                                ) : (
                                    <div style={{width: '24%', height: 'auto'}}/>
                                )
                            }
                            {
                                compras [((4 * numprod) + 2)] ? (
                                    <div style={{width: '24%', height: 'auto'}}>
                                        <CardProducto producto={compras[((4 * numprod) + 2)]} key={((4 * numprod) + 2)} index={((4 * numprod) + 2)} proporcional={proporcional} view_producto={view_producto}/>
                                    </div>
                                ) : (
                                    <div style={{width: '24%', height: 'auto'}}/>
                                )
                            }
                            {
                                compras [((4 * numprod) + 3)] ? (
                                    <div style={{width: '24%', height: 'auto'}}>
                                        <CardProducto producto={compras[((4 * numprod) + 3)]} key={((4 * numprod) + 3)} index={((4 * numprod) + 3)} proporcional={proporcional} view_producto={view_producto}/>
                                    </div>
                                ) : (
                                    <div style={{width: '24%', height: 'auto'}}/>
                                )
