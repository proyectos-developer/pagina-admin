...
export default function DetallesProductoFavorito({proporcional}) {
  ...
  useEffect(() => {
    if (data_favoritos.producto === undefined){
        ...
        dispatch(favoritosdata(favoritosConstants(location.pathname.split('/')[6], 0, 0, 0, 0, 0, 0, 16, {}, false).get_clientes_producto_favorito_filter))
    }else{
            ...
            lista_grid_favoritos && lista_grid_favoritos.length > 0 && view_favorito === 'grid' ? (
                        ...
                        <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                            {
                                favoritos [(4 * numfav)] ? (
                                    <div style={{width: '24%', height: 'auto'}}>
                                        <CardCliente favorito={favoritos[(4 * numfav)]} key={(4 * numfav)} index={(4 * numfav)} proporcional={proporcional} view_favorito={view_favorito}/>
                                    </div>
                                ) : (
                                    <div style={{width: '24%', height: 'auto'}}/>
                                )
                            }
                            {
                                favoritos [((4 * numfav) + 1)] ? (
                                    <div style={{width: '24%', height: 'auto'}}>
                                        <CardCliente favorito={favoritos[((4 * numfav) + 1)]} key={((4 * numfav) + 1)} index={((4 * numfav) + 1)} proporcional={proporcional} view_favorito={view_favorito}/>
                                    </div>
                                ) : (
                                    <div style={{width: '24%', height: 'auto'}}/>
                                )
                            }
                            {
                                favoritos [((4 * numfav) + 2)] ? (
                                    <div style={{width: '24%', height: 'auto'}}>
                                        <CardCliente favorito={favoritos[((4 * numfav) + 2)]} key={((4 * numfav) + 2)} index={((4 * numfav) + 2)} proporcional={proporcional} view_favorito={view_favorito}/>
                                    </div>
                                ) : (
                                    <div style={{width: '24%', height: 'auto'}}/>
                                )
                            }
                            {
                                favoritos [((4 * numfav) + 3)] ? (
                                    <div style={{width: '24%', height: 'auto'}}>
                                        <CardCliente favorito={favoritos[((4 * numfav) + 3)]} key={((4 * numfav) + 3)} index={((4 * numfav) + 3)} proporcional={proporcional} view_favorito={view_favorito}/>
                                    </div>
                                ) : (
                                    <div style={{width: '24%', height: 'auto'}}/>
                                )
                ...
                lista_favoritos && lista_favoritos.length > 0 && view_favorito === 'lista' ? (
                    lista_favoritos.map ((favorito, numfav) => {
                        return (
                            <CardCliente favorito={favorito} key={numfav} index={numfav} proporcional={proporcional} view_favorito={view_favorito}/>
                        )
                    })
            ) : null
        }       
