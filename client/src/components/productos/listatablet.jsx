...
import CardProductoTablet from './card/producto.jsx'
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    productos [(2 * numprod)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardProductoTablet producto={productos[(2 * numprod)]} key={(2 * numprod)} index={(2 * numprod)} proporcional={proporcional} view_producto={view_producto}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    productos [((2 * numprod) + 1)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardProductoTablet producto={productos[((2 * numprod) + 1)]} key={((2 * numprod) + 1)} index={((2 * numprod) + 1)} proporcional={proporcional} view_producto={view_producto}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
