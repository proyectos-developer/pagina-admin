...
import NuevaMarcaCell from './menu/nuevamarcacell.jsx'
...
export default function MarcaPanelCell ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_marca ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevaMarcaCell proporcional={proporcional} marca={marca}/>
