...
export default function DetallesCategoriaTablet ({proporcional}) {
    ...
    useEffect(() => {
        if (data_categoria.categoria === undefined){
            dispatch(categoriasdata(categoriasConstants(location.pathname.split ('/')[3], 0, 0, 0, 0, 16, {}, false).get_categoria))
        }else{
    ...
    useEffect(() => {
        return (() => {
            ...
            dispatch(categoriasdata(categoriasConstants(0, 0, 0, 0, 0, 0, {}, true).update_categoria))
        })
    }, [])
