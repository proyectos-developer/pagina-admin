...
export default function CardSubCategoriaCell ({proporcional, index, sub_categoria, view_subcategoria}) {
    ...
    const ver_sub_categoria = () => {
        ...
        navigate (`/panel/almacen/sub-categorias/sub-categoria/${sub_categoria.sub_categoria.replace(' ', '-')}/${sub_categoria.id}`)
    }
                    ...
                    <div key={index} className='rounded' style={{width: '100%', height: 80 / proporcional, 
                        ...
                        <div style={{width: '100%', height: 80 / proporcional, padding: 10 / proporcional, cursor: 'pointer'}}
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 60 / proporcional}}>
                                ...
                                <div className='d-flex justify-content-end' style={{width: '20%', height: 60 / proporcional,
