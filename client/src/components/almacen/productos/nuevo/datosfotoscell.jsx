...
export default function DatosFotosCell ({proporcional}) {
        ...
        <div style={{width: '100%', height: 'auto'}}>
            <div className='' 
                ...
                <div className='' style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 350 / proporcional, marginBottom: 16 / proporcional}}>
                        {
                            url_foto_principal !== '' ? (
                                <img className='rounded' src={url_foto_principal} style={{width: 350 / proporcional, height: 350 / proporcional}}/>
                            ) : (
                                <div className='rounded' style={{width: 350 / proporcional, height: 350 / proporcional, border: '1px solid #4a4a4a'}}/>
                            )
                        }
                    </div>
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                        <div className='d-flex justify-content-center' style={{width: '48%', height: 'auto'}}>
                            {
                                url_foto_uno !== '' ? (
                                    <img className='rounded' src={url_foto_uno} style={{width: 200 / proporcional, height: 200 / proporcional}}/>
                                ) : (
                                    <div className='rounded' style={{width: 200 / proporcional, height: 200 / proporcional, border: '1px solid #4a4a4a'}}/>
                                )
                            }
                        </div>
                        <div className='d-flex justify-content-center' style={{width: '48%', height: 'auto'}}>
                            {
                                url_foto_dos !== '' ? (
                                    <img className='rounded' src={url_foto_dos} style={{width: 200 / proporcional, height: 200 / proporcional}}/>
                                ) : (
                                    <div className='rounded' style={{width: 200 / proporcional, height: 200 / proporcional, border: '1px solid #4a4a4a'}}/>
                                )
                            }
                    ...
                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                        <div className='d-flex justify-content-center' style={{width: '48%', height: 'auto'}}>
                            {
                                url_foto_tres !== '' ? (
                                    <img className='rounded' src={url_foto_tres} style={{width: 200 / proporcional, height: 200 / proporcional}}/>
                                ) : (
                                    <div className='rounded' style={{width: 200 / proporcional, height: 200 / proporcional, border: '1px solid #4a4a4a'}}/>
                                )
                            }
                        ...
                        <div className='d-flex justify-content-center' style={{width: '48%', height: 'auto'}}>
                            {
                                url_foto_cuatro !== '' ? (
                                    <img className='rounded' src={url_foto_cuatro} style={{width: 200 / proporcional, height: 200 / proporcional}}/>
                                ) : (
                                    <div className='rounded' style={{width: 200 / proporcional, height: 200 / proporcional, border: '1px solid #4a4a4a'}}/>
                                )
                            }
