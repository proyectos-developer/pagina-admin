...
import {set_data_producto_detalles, set_data_producto_precios, set_data_producto_caracteristicas, 
      set_data_producto_fotos, set_datos_paso_producto} from '../../../../redux/actions/data'
...
export default function DatosDetallesTablet ({proporcional}) {
    ...
    const {data_producto_detalles} = useSelector(({data_actions}) => data_actions)
    ...
    useEffect(() => {
        if (data_producto_detalles && data_producto_detalles.producto){
            setProducto(data_producto_detalles.producto)
            setDescripcion(data_producto_detalles.descripcion)
            setCategoria(data_producto_detalles.categoria)
            setIdCategoria(data_producto_detalles.id_categoria)
            setSubCategoria(data_producto_detalles.subcategoria)
            setIdSubCategoria(data_producto_detalles.id_subcategoria)
            setIdServicio(data_producto_detalles.id_servicio)
            setServicio(data_producto_detalles.servicio)
            setProveedor(data_producto_detalles.proveedor)
            setIdProveedor(data_producto_detalles.id_proveedor)
            setMarca(data_producto_detalles.marca)
            setIdMarca(data_producto_detalles.id_marca)
            setStock(data_producto_detalles.stock)
            setIdUnidad(data_producto_detalles.id_unidad)
            ...
            setIdUnidad('')
            setUnidad('')
            selectRefCategorias.current !== null ? selectRefCategorias.current.value = '0' : null
            selectRefSubCategorias.current !== null ? selectRefSubCategorias.current.value = '0' : null
            selectRefUnidades.current !== null ? selectRefUnidades.current.value = '0' : null
            selectRefServicios.current !== null ? selectRefServicios.current.value = '0' : null
            selectRefProveedores.current !== null ? selectRefProveedores.current.value = '0' : null
            selectRefMarcas.current !== null ? selectRefMarcas.current.value = '0' : null
        }
    }, [])
            ...
            <div className='' 
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                    ...
                    <div className={boton_siguiente ? 'shadow rounded' : 'shadow-sm rounded'} 
                        ...
                        onClick={() => continuar_datos_precios()}>
                        <p style={{color: 'white', marginBottom: 0 / proporcional, fontSize: 18 / proporcional, lineHeight: `${50 / proporcional}px`,
                            fontFamily: 'Poppins, sans-serif', textAlign: 'center', fontWeight: 600}}>
                            Continuar
                        </p>
