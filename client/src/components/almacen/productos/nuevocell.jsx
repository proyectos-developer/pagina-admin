...
import DatosDetallesCell from './nuevo/datosdetallescell.jsx'
import DatosPreciosCell from './nuevo/datosprecioscell.jsx'
import DatosCaracteristicasCell from './nuevo/datoscaraceristicascell.jsx'
import DatosFotosCell from './nuevo/datosfotoscell.jsx'
                        ...
                        <div style={{width: '100%', height: 'auto'}}>
                            {
                                datos_paso_producto === 'detalles' || datos_paso_producto === 'guardar' ? ( 
                                    <DatosDetallesCell proporcional={proporcional}/>
                                ) : datos_paso_producto === 'precios' ? (
                                    <DatosPreciosCell proporcional={proporcional}/>
                                ) : datos_paso_producto === 'caracteristicas' ? (
                                    <DatosCaracteristicasCell proporcional={proporcional}/>
                                ) : datos_paso_producto === 'fotos' ? (
                                    <DatosFotosCell proporcional={proporcional}/>
                                ) : null
                            }
                        </div>
                    </div>
