...
import { set_data_proveedor, set_data_editable } from '../../../../redux/actions/data'
...
export default function CardProveedorCell ({proporcional, index, proveedor}) {
    ...
    const ver_proveedor = () => {
        ...
        dispatch (set_data_proveedor(proveedor))
        navigate (`/panel/almacen/proveedores/proveedor/${proveedor.nombre_empresa}/${proveedor.id}`)
    }
    ...
    const eliminar_proveedor = () => {
        dispatch (proveedoresdata(proveedoresConstants(proveedor.id, 0, 0, 0, 0, 16, {}, false).delete_proveedor))
    }
    ...
    return (
        <div key={index} className='rounded' style={{width: '100%', height: '100%', 
            ...
            <div style={{width: '100%', height: 'auto', padding: 10 / proporcional, cursor: 'pointer'}}
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 160 / proporcional}}>
                    <div className='d-flex justify-content-between' style={{width: '70%', height: 160 / proporcional}}>
                        <div className='' style={{width: '48%', height: 160 / proporcional}}>
                            <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                ...
                                <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{proveedor.nombre_empresa}</span>
                            </h4>
                            <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                color: 'rgb(89, 89, 89)', fontFamily: 'Merriweather', fontWeight: 600, textAlign: 'left'}}>
                                <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{proveedor.tipo_proveedor}</span>
                            </h4>
                            <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                color: 'rgb(89, 89, 89)', fontFamily: 'Merriweather', fontWeight: 600, textAlign: 'left'}}>
                                <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{proveedor.correo}</span>
                            </h4>
                            <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                color: 'rgb(89, 89, 89)', fontFamily: 'Merriweather', fontWeight: 600, textAlign: 'left'}}>
                                <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{proveedor.nro_telefono}</span>
                            </h4>
                        </div>
                    </div>
                    <div className='d-flex justify-content-end' style={{width: '30%', height: 160 / proporcional,
