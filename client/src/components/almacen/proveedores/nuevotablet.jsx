...
import DatosGeneralTablet from './nuevo/datosgeneraltablet.jsx'
import DatosComercialTablet from './nuevo/datoscomercialtablet.jsx'
import DatosFinanieraTablet from './nuevo/datosfinancieratablet.jsx'
import DatosEvaluacionTablet from './nuevo/datosevaluaciontablet.jsx'
import DatosAdicionalTablet from './nuevo/datosadicionaltablet.jsx'
...
export default function NuevoProveedorTablet ({proporcional}) {
                        ...
                        <div style={{width: data_proveedor_general && data_proveedor_general.foto ? '73%' : '100%', height: 'auto'}}>
                            {
                                datos_paso_proveedor === 'general' || datos_paso_proveedor === 'guardar' ? ( 
                                    <DatosGeneralTablet proporcional={proporcional}/>
                                ) : datos_paso_proveedor === 'comercial' ? (
                                    <DatosComercialTablet proporcional={proporcional}/>
                                ) : datos_paso_proveedor === 'financiera' ? (
                                    <DatosFinanieraTablet proporcional={proporcional}/>
                                ) : datos_paso_proveedor === 'evaluacion' ? (
                                    <DatosEvaluacionTablet proporcional={proporcional}/>
                                ) : datos_paso_proveedor === 'adicional' ? (
                                    <DatosAdicionalTablet proporcional={proporcional}/>
                                ): null
                            }
                        </div>
                    </div>
