...
export default function NuevoProveedorTablet({proporcional, proveedor}) {
        ...
        <div className='' style={{width: '100%', height: 'auto'}}>
            ...
            <div className='' style={{width: '100%', height: 'auto', padding: 10 / proporcional }}>
                <h2 style={{fontSize: 20 / proporcional, lineHeight: `${30 / proporcional}px`, fontWeight: 500, marginBottom: 0,
                    fontFamily: 'Poppins, sans-serif', color: '#4a4a4a'}}>Nuevo proveedor <strong style={{color: '#007bff'}}>({proveedor.nombre_empresa})</strong>
                </h2>
            </div>
        </div>
    )
