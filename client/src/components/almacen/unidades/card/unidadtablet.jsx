...
import { set_data_unidad, set_data_editable } from '../../../../redux/actions/data'
...
export default function CardUnidadTablet ({proporcional, index, unidad}) {
    ...
    const ver_unidad = () => {
        ...
        navigate (`/panel/almacen/unidades/unidad/${unidad.unidad}/${unidad.id}`)
    }
    ...
    const eliminar_unidad = () => {
        dispatch (unidadesdata(unidadesConstants(unidad.id, 0, 0, 0, 0, 16, {}, false).delete_unidad))
    }
                    ...
                    <div className='d-flex justify-content-between' style={{width: '70%', height: 40 / proporcional}}>
                        <div className='' style={{width: '48%', height: 40 / proporcional}}>
                            <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                ...
                                <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{unidad.unidad}</span>
                            </h4>
                        </div>
                        <div className='' style={{width: '48%', height: 40 / proporcional}}>
                            <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                color: 'rgb(89, 89, 89)', fontFamily: 'Merriweather', fontWeight: 600, textAlign: 'left'}}>
                                <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{unidad.medida}</span>
                            </h4>
                        </div>
                    </div>
