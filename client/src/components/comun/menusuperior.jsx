...
import CardAgenda from './card/agenda.jsx'
...
export default function MenuSuperior ({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 100 / proporcional, padding: 20 / proporcional, paddingLeft: 100 / proporcional, paddingRight: 100 / proporcional}}>
                                            ...
                                            background: 'white'}}>
                                        {
                                            lista_notificaciones && lista_notificaciones.length > 0 ? (
                                                lista_notificaciones.map ((notificacion, index) => {
                                                    return (
                                                        <CardNotificacion notificacion={notificacion} index={index} key={index} proporcional={proporcional} cantidad={lista_notificaciones.length}/>
                                                    )
                                                })
                                            ) : null
                                        }
                                            ...
                                            background: 'white'}}>
                                        {
                                            lista_mensajes && lista_mensajes.length > 0 ? (
                                                lista_mensajes.map ((mensaje, index) => {
                                                    return (
                                                        <CardMensaje mensaje={mensaje} index={index} key={index} proporcional={proporcional} cantidad={lista_mensajes.length}/>
                                                    )
                                                })
                                            ) : null
                                        }
                                            ...
                                            background: 'white'}}>
                                        {
                                            lista_reuniones && lista_reuniones.length > 0 ? (
                                                lista_reuniones.map ((reunion, index) => {
                                                    return (
                                                        <CardAgenda reunion={reunion} index={index} key={index} proporcional={proporcional} cantidad={lista_reuniones.length}/>
                                                    )
                                                })
                                            ) : null
                                        }
