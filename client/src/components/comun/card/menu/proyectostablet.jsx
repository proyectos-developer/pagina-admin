...
export default function CardMenuProyectosTablet({proporcional}) {
                                ...
                                menu === 'clientes' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                            ...
                                            onClick={() => {navigate ('/panel/proyectos/clientes'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/proyectos/clientes/nuevo'); dispatch(set_open_menu_lateral(true));
                                ...
                                menu === 'tipos-proyectos' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/proyectos/tipos-proyectos'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/proyectos/tipos-proyectos/nuevo'); dispatch(set_open_menu_lateral(true));
                                ...
                                menu === 'proyectos' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/proyectos/proyectos'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/proyectos/proyectos/nuevo'); dispatch(set_open_menu_lateral(true));
                                ...
                                menu === 'gestion-proyectos' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/proyectos/gestion-proyectos'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/proyectos/gestion-proyectos/nuevo'); dispatch(set_open_menu_lateral(true));
                                ...
                                menu === 'presupuestos' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/proyectos/presupuestos'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/proyectos/presupuestos/nuevo'); dispatch(set_open_menu_lateral(true));
