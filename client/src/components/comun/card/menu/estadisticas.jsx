...
export default function CardMenuEstadisticas({proporcional}) {
                                ...
                                menu === 'favoritos' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                            ...
                                            onClick={() => {navigate ('/panel/estadisticas/favoritos'); dispatch(set_open_menu_lateral(false));
                                ...
                                menu === 'calificaciones' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/estadisticas/calificaciones'); dispatch(set_open_menu_lateral(false));
