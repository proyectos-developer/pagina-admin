...
export default function CardMenuContabilidad({proporcional}) {
                                ...
                                menu === 'facturacion' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                            ...
                                            onClick={() => {navigate ('/panel/contabilidad/facturacion'); dispatch(set_open_menu_lateral(false));
                                        ...
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/contabilidad/facturacion/nuevo'); dispatch(set_open_menu_lateral(false));
                                ...
                                menu === 'facturas' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/contabilidad/facturas'); dispatch(set_open_menu_lateral(false));
                                        ...
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/contabilidad/facturas/nuevo'); dispatch(set_open_menu_lateral(false));
