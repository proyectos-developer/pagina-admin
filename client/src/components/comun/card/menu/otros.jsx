...
export default function CardMenuOtros({proporcional}) {
                                ...
                                menu === 'suscriptores' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                            ...
                                            onClick={() => {navigate ('/panel/otros/suscriptores'); dispatch(set_open_menu_lateral(false));
                                ...
                                menu === 'categorias-noticias' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/otros/categorias-noticias'); dispatch(set_open_menu_lateral(false));
                                        ...
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/otros/categorias-noticias/nuevo'); dispatch(set_open_menu_lateral(false));
                                ...
                                menu === 'noticias' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/otros/noticias'); dispatch(set_open_menu_lateral(false));
                                        ...
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/otros/noticias/nuevo'); dispatch(set_open_menu_lateral(false));
                                                dispatch (set_opcion_menu_lateral({sector: 'otros', menu: 'nuevo-noticia', sub_menu: sub_menu === 'nuevo-noticia' ? '' : 'nuevo-noticia'}))
                                            }}
                                            onMouseOver={() => setSeleccionSubMenu('nuevo-noticia')}
                                            onMouseLeave={() => setSeleccionSubMenu('')}>
