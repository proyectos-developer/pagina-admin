...
export default function CardMenuAlmacenCell({proporcional}) {
                                ...
                                menu === 'productos' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                            ...
                                            onClick={() => {navigate ('/panel/almacen/productos'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/almacen/productos/nuevo'); dispatch(set_open_menu_lateral(true));
                                ...
                                menu === 'categorias' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/almacen/categorias'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/almacen/categorias/nuevo'); dispatch(set_open_menu_lateral(true));
                                ...
                                menu === 'sub-categorias' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/almacen/sub-categorias'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/almacen/sub-categorias/nuevo'); dispatch(set_open_menu_lateral(true));
                                ...
                                menu === 'unidades' ? (
                                    <div style={{width: '100%', height: 'auto', padding: 10 / proporcional}}>
                                        <div className='d-flex'
                                                style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                            cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                            onClick={() => {navigate ('/panel/almacen/unidades'); dispatch(set_open_menu_lateral(true));
                                        ...
                                        <div className='d-flex'
                                            style={{width: '100%', height: 30 / proporcional, marginTop: 5 / proporcional,
                                                    cursor: 'pointer', marginBottom: 5 / proporcional}} 
                                                    onClick={() => {navigate ('/panel/almacen/unidades/nuevo'); dispatch(set_open_menu_lateral(true));
