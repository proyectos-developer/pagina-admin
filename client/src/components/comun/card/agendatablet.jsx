...
export default function CardAgendaTablet ({proporcional, index, reunion, cantidad}) {
    ...
    const marcar_leido = () => {
        ...
        dispatch (reunionesdata(reunionesConstants(reunion.id, 0, 0, 0, 0, 0, 10, data_update, false).update_reunion_leida))
    }
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 40 / proporcional}}>
                <div className='d-flex' style={{width: 'auto', height: 40 / proporcional}}>
                    <div className='rounded-circle' 
                        ...
                        {
                            reunion.url_foto !== '' ? (
                                <img className='rounded-circle' src={reunion.url_foto} 
                    ...
                    <div style={{width: 'auto', height: 40 / proporcional, paddingTop: 4 / proporcional, paddingBottom: 4 / proporcional}}>
                        <p style={{fontSize: 12 / proporcional, lineHeight: `${16 / proporcional}px`, marginBottom: 0,
                            ...
                            <span style={{fontSize: 14 / proporcional, color: '#007bff'}}> {(new Date(reunion.fecha_reunion)).toDateString()} - {reunion.hora} hrs</span>
                        </p>
                        <p style={{fontSize: 12 / proporcional, lineHeight: `${16 / proporcional}px`, marginBottom: 0,
                            color: '#007bff', fontFamily: 'Poppins, sans-serif', fontWeight: 500, cursor: 'default'}}>
                            <span style={{fontSize: 14 / proporcional, color: 'rgb(89, 89, 89)'}}> {reunion.titulo}</span>
                        </p>
                    </div>
                </div>
