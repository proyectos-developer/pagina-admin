...
export default function ListaMensajesCell ({proporcional}) {
    ...
    const dividir_nro_columnas = (data_mensajes) => {
        ...
        setListaGridMensajes (data_mensajes.mensajes)
                        ...
                        return (
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                <div style={{width: '90%', height: 'auto'}}>
                                    <CardMensajeCell mensaje={mensaje} key={nummen} index={nummen} proporcional={proporcional} view_mensaje={view_mensaje}/>
                                </div>
                            </div>
                        )
                    })
