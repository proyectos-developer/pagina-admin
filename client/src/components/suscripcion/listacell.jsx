...
export default function ListaSuscriptoresCell ({proporcional}) {
    ...
    const dividir_nro_columnas = (data_servicios) => {
        ...
        setListaGridSuscriptores (data_servicios.suscripciones)
                        ...
                        return (
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                <div style={{width: '90%', height: 'auto'}}>
                                    <CardSuscripcionCell suscripcion={suscripcion} key={numsusc} index={numsusc} proporcional={proporcional} view_suscripcion={view_suscripcion}/>
                                </div>
                            </div>
                        )
                    })
