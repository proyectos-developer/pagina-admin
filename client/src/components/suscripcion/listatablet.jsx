                ...
                lista_grid_suscriptores && lista_grid_suscriptores.length > 0 && view_suscripcion === 'grid' ? (
                    lista_grid_suscriptores.map ((suscripcion, numsusc) => {
                        return (
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    suscriptores [(2 * numsusc)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardSuscripcionTablet suscripcion={suscriptores[(2 * numsusc)]} key={(2 * numsusc)} index={(2 * numsusc)} proporcional={proporcional} view_suscripcion={view_suscripcion}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    suscriptores [((2 * numsusc) + 1)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardSuscripcionTablet suscripcion={suscriptores[((2 * numsusc) + 1)]} key={((2 * numsusc) + 1)} index={((2 * numsusc) + 1)} proporcional={proporcional} view_suscripcion={view_suscripcion}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
                    ...
                    lista_suscriptores && lista_suscriptores.length > 0 && view_suscripcion === 'lista' ? (
                        lista_suscriptores.map ((suscripcion, numsusc) => {
                            return (
                                <CardSuscripcionTablet suscripcion={suscripcion} key={numsusc} index={numsusc} proporcional={proporcional} view_suscripcion={view_suscripcion}/>
                            )
                        })
                ) : null
            }                  
