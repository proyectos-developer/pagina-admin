...
export default function ListaReunionesCell ({proporcional}) {
    ...
    const dividir_nro_columnas = (data_reuniones) => {
        ...
        setListaGridReuniones (data_reuniones.reuniones)
                        ...
                        return (
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                <div style={{width: '90%', height: 'auto'}}>
                                    <CardReunionCell reunion={reunion} key={numreu} index={numreu} proporcional={proporcional} view_reunion={view_reunion}/>
                                </div>
                            </div>
                        )
                    })
