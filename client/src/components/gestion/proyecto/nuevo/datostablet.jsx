...
import TareasProyectoTablet from './tareasproyectotablet.jsx'
import TrabajadorProyectoTablet from './trabajadorproyectotablet.jsx'
import DocumentosProyectoTablet from './documentosproyectotablet.jsx'
import ComunicacionesProyectoTablet from './comunicacionesproyectotablet.jsx'
import RiesgosProyectoTablet from './riesgosproyectotablet.jsx'
import KpisProyectoTablet from './kpisproyectotablet.jsx'

import NuevaTareaTablet from '../menu/nuevatareatablet.jsx'
import NuevoTrabajadorTablet from '../menu/nuevotrabajadortablet.jsx'
import NuevoDocumentoTablet from '../menu/nuevodocumentotablet.jsx'
import NuevoRiesgoTablet from '../menu/nuevoriesgotablet.jsx'
import NuevoKpiTablet from '../menu/nuevokpitablet.jsx'
        ...
        <div className='position-relative' style={{width: '100%', height: '100%', paddingLeft: open_menu_lateral ? 60 / proporcional : 100 / proporcional,
            ...
            <div styl={{width: '100%', height: 'auto'}}>
                {
                    menu_agregar === 'tareas' && datos_proyecto.id !== undefined ? (
                        <TareasProyectoTablet proporcional={proporcional} proyecto={datos_proyecto}/>
                    ) : null
                }
                {
                    menu_agregar === 'trabajadores' && datos_proyecto.id !== undefined ? (
                        <TrabajadorProyectoTablet proporcional={proporcional} proyecto={datos_proyecto}/>
                    ) : null
                }
                {
                    menu_agregar === 'documentos' && datos_proyecto.id !== undefined ? (
                        <DocumentosProyectoTablet proporcional={proporcional} proyecto={datos_proyecto}/>
                    ) : null
                }
                {
                    menu_agregar === 'comunicaciones' && datos_proyecto.id !== undefined ? (
                        <ComunicacionProyectoTablet proporcional={proporcional} proyecto={datos_proyecto}/>
                    ) : null
                }
                {
                    menu_agregar === 'riesgos' && datos_proyecto.id !== undefined ? (
                        <RiesgosProyectoTablet proporcional={proporcional} proyecto={datos_proyecto}/>
                    ) : null
                }
                {
                    menu_agregar === 'kpis' && datos_proyecto.id !== undefined ? (
                        <KpisProyectoTablet proporcional={proporcional} proyecto={datos_proyecto}/>
                    ) : null
                }
            </div>
            {
            ...
            }
            {
                show_trabajador_proyecto ? (
                    <div className='position-fixed end-0 shadow overflow-auto' 
                        style={{width: '60%', height: '92%', background: 'white', zIndex: 9999, top: 80 / proporcional}}>
                        <NuevoTrabajadorTablet proporcional={proporcional} trabajador={trabajador_proyecto} id_proyecto={location.pathname.split('/')[5]}/>
                        <div className='' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
                            <div className={boton_tarea ? 'shadow rounded' : 'shadow-sm rounded'} 
                                style={{width: '100%', height: 50 / proporcional, background: '#007BFF', cursor: 'pointer',
                                        marginBottom: 16 / proporcional
            ...
            }
            {
                show_documento_proyecto ? (
                    <div className='position-fixed end-0 shadow overflow-auto' 
                        style={{width: '60%', height: '92%', background: 'white', zIndex: 9999, top: 80 / proporcional}}>
                        <NuevoDocumentoTablet proporcional={proporcional} documento={documento_proyecto}/>
                        <div className='' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
                            <div className={boton_tarea ? 'shadow rounded' : 'shadow-sm rounded'} 
                                style={{width: '100%', height: 50 / proporcional, background: '#007BFF', cursor: 'pointer',
                                        marginBottom: 16 / proporcional
            ...
            }
            {
                show_riesgo_proyecto ? (
                    <div className='position-fixed end-0 shadow overflow-auto' 
                        style={{width: '60%', height: '92%', background: 'white', zIndex: 9999, top: 80 / proporcional}}>
                        <NuevoRiesgoTablet proporcional={proporcional} riesgo={riesgo_proyecto}/>
                        <div className='' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
                            <div className={boton_tarea ? 'shadow rounded' : 'shadow-sm rounded'} 
                                style={{width: '100%', height: 50 / proporcional, background: '#007BFF', cursor: 'pointer',
                                        marginBottom: 16 / proporcional
            ...
            }
            {
                show_kpi_proyecto ? (
                    <div className='position-fixed end-0 shadow overflow-auto' 
                        style={{width: '60%', height: '92%', background: 'white', zIndex: 9999, top: 80 / proporcional}}>
                        <NuevoKpiTablet proporcional={proporcional} kpi={kpi_proyecto}/>
                        <div className='' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
                            <div className={boton_tarea ? 'shadow rounded' : 'shadow-sm rounded'} 
                                style={{width: '100%', height: 50 / proporcional, background: '#007BFF', cursor: 'pointer',
                                        marginBottom: 16 / proporcional
