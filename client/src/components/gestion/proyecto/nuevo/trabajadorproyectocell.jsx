...
export default function TrabajadorProyectoCell({proporcional, proyecto}) {
    ...
    const buscar_trabajador = () => {
        if (search_trabajador !== ''){
            dispatch (trabajadoresdata(trabajadoresConstants(0, search_trabajador, 0, 0, 0, 0, 0, 20, {}, false).get_trabajadores_filter))
        }else{
            dispatch (trabajadoresdata(trabajadoresConstants(0, 0, 0, 0, 0, 0, 0, 0, {}, false).get_trabajadores_filter))
        }
    }
    ...
    const resetear_data = () => {
        ...
        setRolAsignado('')
        setDisponibilidad('')
        dispatch (trabajadoresdata(trabajadoresConstants(0, 0, 0, 0, 0, 0, 0, 100, {}, false).get_trabajadores_proyecto_filter))
    }
    ...
    return (
        <div style={{width: '100%', height: 'auto', padding: 0 / proporcional, paddingTop: 20 / proporcional, paddingBottom: 20 / proporcional}}>
