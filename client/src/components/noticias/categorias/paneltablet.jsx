...
import NuevaCategoriaNoticiaTablet from './menu/nuevacategorianoticiatablet.jsx'

import { Outlet, useNavigate} from 'react-router-dom'
import { useDispatch, useSelector } from 'react-redux'
import { set_data_categoria_noticia } from '../../../redux/actions/data.js'

export default function CategoriasNoticiasPanelTablet ({proporcional}) {
    ...
    const corregir_informaion = () => {
        ...
        navigate (`/panel/categorias-noticias/categoria-noticia/${categoria_noticia.titulo.replace(' ', '-')}/${categoria_noticia.id}`)
    }
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_categoria_noticia ? (
                    <div className='position-fixed end-0 shadow overflow-auto' 
                        ...
                        <NuevaCategoriaNoticiaTablet proporcional={proporcional} categoria_noticia={categoria_noticia}/>
