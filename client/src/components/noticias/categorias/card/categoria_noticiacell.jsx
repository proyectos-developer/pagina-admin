...
export default function CardCategoriaNoticiaCell ({proporcional, index, categoria_noticia, view_categoria_noticia}) {
    ...
    const ver_categoria_noticia = () => {
        ...
        navigate (`/panel/categorias-noticias/categoria-noticia/${categoria_noticia.categoria_noticia.replace(' ', '-')}/${categoria_noticia.id}`)
    }
