...
export default function DetallesCategoriaNoticiaTablet ({proporcional}) {
    ...
    useEffect(() => {
        if (data_categoria_noticia.categoria_noticia === undefined){
            dispatch(categorias_noticiasdata(categoriasnoticiasConstants(location.pathname.split ('/')[5], 0, 0, 0, 0, 16, {}, false).get_categoria_noticia))
        }else{
