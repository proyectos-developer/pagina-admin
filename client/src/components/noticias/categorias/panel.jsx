...
import NuevaCategoriaNoticia from './menu/nuevacategorianoticia.jsx'

import { Outlet, useNavigate} from 'react-router-dom'
import { useDispatch, useSelector } from 'react-redux'
import { set_data_categoria_noticia } from '../../../redux/actions/data.js'

export default function CategoriasNoticiasPanel ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_categoria_noticia ? (
                    <div className='position-fixed end-0 shadow overflow-auto' 
                        ...
                        <NuevaCategoriaNoticia proporcional={proporcional} categoria_noticia={categoria_noticia}/>
