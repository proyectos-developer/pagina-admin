                ...
                lista_grid_reuniones && lista_grid_reuniones.length > 0 && view_reunion === 'grid' ? (
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    reuniones [(4 * numreu)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardReunion reunion={reuniones[(4 * numreu)]} key={(4 * numreu)} index={(4 * numreu)} proporcional={proporcional} view_reunion={view_reunion}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    reuniones [((4 * numreu) + 1)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardReunion reunion={reuniones[((4 * numreu) + 1)]} key={((4 * numreu) + 1)} index={((4 * numreu) + 1)} proporcional={proporcional} view_reunion={view_reunion}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    reuniones [((4 * numreu) + 2)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardReunion reunion={reuniones[((4 * numreu) + 2)]} key={((4 * numreu) + 2)} index={((4 * numreu) + 2)} proporcional={proporcional} view_reunion={view_reunion}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    reuniones [((4 * numreu) + 3)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardReunion reunion={reuniones[((4 * numreu) + 3)]} key={((4 * numreu) + 3)} index={((4 * numreu) + 3)} proporcional={proporcional} view_reunion={view_reunion}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                    ...
                    lista_reuniones && lista_reuniones.length > 0 && view_reunion === 'lista' ? (
                        lista_reuniones.map ((reunion, numreu) => {
                            return (
                                <CardReunion reunion={reunion} key={numreu} index={numreu} proporcional={proporcional} view_reunion={view_reunion}/>
                            )
                        })
                ) : null
            }                   
