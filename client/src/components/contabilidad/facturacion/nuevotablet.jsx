...
import DatosClienteTablet from './nuevo/datosclientetablet.jsx'
import DatosFiscalesTablet from './nuevo/datosfiscalestablet.jsx'
import DatosProductosServiciosTablet from './nuevo/datosproductosserviciostablet.jsx'
import DatosFacturaTablet from './nuevo/datosfacturatablet.jsx'
...
export default function NuevaFacturaTablet ({proporcional}) {
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    {
                        datos_paso_factura === 'cliente' || datos_paso_factura === 'guardar' ? ( 
                            <DatosClienteTablet proporcional={proporcional}/>
                        ) : datos_paso_factura === 'fiscales' ? (
                            <DatosFiscalesTablet proporcional={proporcional}/>
                        ) : datos_paso_factura === 'productos' ? (
                            <DatosProductosServiciosTablet proporcional={proporcional}/>
                        ) : datos_paso_factura === 'factura' ? (
                            <DatosFacturaTablet proporcional={proporcional}/>
                        ) : null
                    }
                </div>    
            </div>
