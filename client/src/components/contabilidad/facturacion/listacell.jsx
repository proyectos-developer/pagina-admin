...
import CardFacturaCell from './card/facturacell.jsx'
...
export default function ListaFacturacionCell ({proporcional}) {
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_facturas && lista_facturas.length > 0 ? (
                        lista_facturas.map ((factura, index) => {
                            return (
                                <CardFacturaCell proporcional={proporcional} key={index} index={index} factura={factura}/>
                            )
                        })
                    ) : null
                }
