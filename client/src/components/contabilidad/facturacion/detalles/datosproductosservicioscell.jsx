...
import CardDetallesProductoFacturaCell from '../card/detallesproductofacturacell'

export default function DatosProductosServiciosCell ({proporcional, factura}) {
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                {
                    lista_productos_factura && lista_productos_factura.length > 0 ? (
                        lista_productos_factura.map ((producto, index) => {
                            return (
                                <CardDetallesProductoFacturaCell producto={producto} index={index} key={index} proporcional={proporcional} editar={editar_informacion}/>
                            )
                        })
                    ) : null
                }
