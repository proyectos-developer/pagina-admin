...
export default function ListaFacturacion ({proporcional}) {
    ...
    useEffect(() => {
        if (delete_factura && delete_factura.success === true && delete_factura.facturas){
            ...
            dispatch (facturasdata(facturasConstants(0, 0, 0, 0, 0, 0, 0, 16, {}, true).delete_factura))
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_facturas && lista_facturas.length > 0 ? (
                        lista_facturas.map ((factura, index) => {
                            return (
                                <CardFactura proporcional={proporcional} key={index} index={index} factura={factura}/>
                            )
                        })
                    ) : null
                }
