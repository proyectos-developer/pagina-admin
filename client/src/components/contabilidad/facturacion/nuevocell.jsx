...
import DatosClienteCell from './nuevo/datosclientecell.jsx'
import DatosFiscalesCell from './nuevo/datosfiscalescell.jsx'
import DatosProductosServiciosCell from './nuevo/datosproductosservicioscell.jsx'
import DatosFacturaCell from './nuevo/datosfacturacell.jsx'
...
export default function NuevaFacturaCell ({proporcional}) {
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    {
                        datos_paso_factura === 'cliente' || datos_paso_factura === 'guardar' ? ( 
                            <DatosClienteCell proporcional={proporcional}/>
                        ) : datos_paso_factura === 'fiscales' ? (
                            <DatosFiscalesCell proporcional={proporcional}/>
                        ) : datos_paso_factura === 'productos' ? (
                            <DatosProductosServiciosCell proporcional={proporcional}/>
                        ) : datos_paso_factura === 'factura' ? (
                            <DatosFacturaCell proporcional={proporcional}/>
                        ) : null
                    }
                </div>    
            </div>
