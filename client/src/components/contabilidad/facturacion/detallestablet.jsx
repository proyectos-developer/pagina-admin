...
import DatosClienteTablet from './detalles/datosclientetablet.jsx'
import DatosFiscalesTablet from './detalles/datosfiscalestablet.jsx'
import DatosProductosServiciosTablet from './detalles/datosproductosserviciostablet.jsx'
import DatosFacturaTablet from './detalles/datosfacturatablet.jsx'

export default function DetallesFacturaTablet ({proporcional}) {
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        {
                            datos_paso_factura === 'cliente' && factura.nombres ? ( 
                                <DatosClienteTablet proporcional={proporcional} factura={factura}/>
                            ) : datos_paso_factura === 'fiscal' && factura.nombres ? (
                                <DatosFiscalesTablet proporcional={proporcional} factura={factura}/>
                            ) : datos_paso_factura === 'productos' && factura.nombres ? (
                                <DatosProductosServiciosTablet proporcional={proporcional} factura={factura}/>
                            ) : datos_paso_factura === 'fiscal' && factura.nombres ? (
                                <DatosFacturaTablet proporcional={proporcional} factura={factura}/>
                            ) : null
                        }
                    </div>
                </div>
