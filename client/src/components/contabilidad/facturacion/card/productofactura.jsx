...
export default function CardProductoFactura ({proporcional, index, producto}) {
    ...
    return (
        <div className='d-flex justify-content-between' key={index} 
            ...
            <div className='d-flex jsutify-content-between' 
                style={{width: '5%', height: 96 / proporcional}}>   
                <div className='d-flex justify-content-center' style={{width: '100%', height: 96 / proporcional}}>
                    <p style={{lineHeight: `${96 / proporcional}px`, fontSize: 14 / proporcional, 
            ...
            <div className='' key={index} 
                ...
                <div className='d-flex justify-content-between' key={index} 
                    ...
                    <div className='position-relative' style={{width: '39%', height: 'auto', marginBottom: 16 / proporcional}}>
                    ...
                    <div className='position-relative' style={{width: '19%', height: 'auto', marginBottom: 16 / proporcional}}>
                        <span className='position-absolute'  
                            style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                                left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                                background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
                    ...
                    <div className='position-relative d-flex justify-content-between' style={{width: '19%', height: 'auto', marginBottom: 16 / proporcional}}>
                        <span className='position-absolute'  
                            style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                                left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                                background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
            ...
            <div className='d-flex jsutify-content-between' 
                style={{width: '20%', height: 96 / proporcional, paddingTop: 28 / proporcional,
                    paddingBottom: 28 / proporcional
                }}>   
                <div className='d-flex justify-content-center' style={{width: '48%', height: 40 / proporcional}}>
                    <p style={{lineHeight: `${40 / proporcional}px`, fontSize: 14 / proporcional, 
                            color: 'rgb(89, 89, 89)', cursor: 'pointer',
                            fontWeight: boton_actualizar ? 700 : 500,
                            fontFamily: 'Poppins, sans-serif', background: 'white'}}
                    onClick={() => actualizar_producto()}
