...
export default function CardProductoFacturaTablet ({proporcional, index, producto}) {
        ...
        <div className='d-flex justify-content-between' key={index} 
            ...
            <div className='' key={index} 
                ...
                <div className='d-flex justify-content-between' key={index} 
                    ...
                    <div className='position-relative d-flex justify-content-between' style={{width: '32%', height: 'auto', marginBottom: 16 / proporcional}}>
                        <span className='position-absolute'  
                            style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                                left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                                background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
            ...
            <div className='' 
                style={{width: '20%', height: 152 / proporcional
                }}>   
