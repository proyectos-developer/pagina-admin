...
import NuevaFactura from './menu/nuevafactura.jsx'
import UpdateFactura from './menu/updatefactura.jsx'
...
export default function FacturacionPanel ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_factura_guardada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevaFactura proporcional={proporcional} factura={factura}/>
            ...
            }
            {
                show_factura_actualizada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '30%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateFactura proporcional={proporcional} factura={factura}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
