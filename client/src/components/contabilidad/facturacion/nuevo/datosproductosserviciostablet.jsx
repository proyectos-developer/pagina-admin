...
import CardProductoFacturaTablet from '../card/productofacturatablet'

export default function DatosProductosServiciosTablet ({proporcional}) {
            ...
            <div style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                {
                    lista_productos_factura && lista_productos_factura.length > 0 ? (
                        lista_productos_factura.map ((producto, index) => {
                            return (
                                <CardProductoFacturaTablet producto={producto} index={index} key={index} proporcional={proporcional}/>
                            )
                        })
                    ) : null
                }
