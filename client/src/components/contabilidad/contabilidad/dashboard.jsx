...
export default function ContabilidadDashboard({proporcional}) {
                                    ...
                                    <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                                        <div style={{width: '48%',  height: 'auto'}}>
                                            <p style={{fontSize: 16 / proporcional, lineHeight: `${20 / proporcional}px`, color: '#007bff',
                                                ...
                                                {factura.cliente} / {factura.razon_social}
                                            </p>
                                        </div>
                                        <div style={{width: '48%',  height: 'auto'}}>
                                            <p style={{fontSize: 16 / proporcional, lineHeight: `${20 / proporcional}px`, color: '#007bff',
                                                marginBottom: 0 / proporcional, fontFamily: 'Poppins, sans-serif', fontWeight: 500, cursor: 'pointer'}}>
                                                {factura.nro_ruc} / {factura.nro_documento}
                                            </p>
                                        </div>
                                        <div style={{width: '48%',  height: 'auto'}}>
                                            <p style={{fontSize: 16 / proporcional, lineHeight: `${20 / proporcional}px`, color: '#007bff',
                                                marginBottom: 0 / proporcional, fontFamily: 'Poppins, sans-serif', fontWeight: 500, cursor: 'pointer'}}>
                                                {factura.nro_telefono}
                                            </p>
                                        </div>
                                        <div style={{width: '48%',  height: 'auto'}}>
                                            <p style={{fontSize: 16 / proporcional, lineHeight: `${20 / proporcional}px`, color: '#007bff',
