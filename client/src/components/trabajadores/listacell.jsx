...
export default function ListaTrabajadoresTablet ({proporcional}) {
    ...
    const dividir_nro_columnas = (data_trabajadores) => {
        ...
        setListaGridTrabajadores (data_trabajadores.trabajadores)
                        ...
                        return (
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                <div style={{width: '90%', height: 'auto'}}>
                                    <CardTrabajadorCell trabajador={trabajador} key={numtrab} index={numtrab} proporcional={proporcional} view_trabajador={view_trabajador}/>
                                </div>
                            </div>
                        )
                    })
