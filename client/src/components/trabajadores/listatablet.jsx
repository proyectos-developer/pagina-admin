                ...
                lista_grid_trabajadores && lista_grid_trabajadores.length > 0 && view_trabajador === 'grid' ? (
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    trabajadores [(2 * numtrab)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardTrabajadorTablet trabajador={trabajadores[(2 * numtrab)]} key={(2 * numtrab)} index={(2 * numtrab)} proporcional={proporcional} view_trabajador={view_trabajador}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    trabajadores [((2 * numtrab) + 1)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardTrabajadorTablet trabajador={trabajadores[((2 * numtrab) + 1)]} key={((2 * numtrab) + 1)} index={((2 * numtrab) + 1)} proporcional={proporcional} view_trabajador={view_trabajador}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
                    ...
                    lista_trabajadores && lista_trabajadores.length > 0 && view_trabajador === 'lista' ? (
                        lista_trabajadores.map ((trabajador, numtrab) => {
                            return (
                                <CardTrabajadorTablet trabajador={trabajador} key={numtrab} index={numtrab} proporcional={proporcional} view_trabajador={view_trabajador}/>
                            )
                        })
                ) : null
            }                  
