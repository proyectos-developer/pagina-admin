...
export default function NuevoTrabajadorTablet({proporcional, trabajador}) {
    ...
    return (
        <div className='' style={{width: '100%', height: 'auto'}}>
            ...
            <div style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
                ...
                <h4 style={{fontSize: 16 / proporcional, lineHeight: `${24 / proporcional}px`, fontWeight: 500, marginBottom: 16 / proporcional,
                    fontFamily: 'Poppins, sans-serif', color: '#4a4a4a'}}>Área empresa: 
                    <span style={{fontSize: 18 / proporcional, fontWeight: 600, color: '#007bff'}}> {trabajador.area_empresa}</span>
                </h4>
                <h4 style={{fontSize: 16 / proporcional, lineHeight: `${24 / proporcional}px`, fontWeight: 500, marginBottom: 16 / proporcional,
