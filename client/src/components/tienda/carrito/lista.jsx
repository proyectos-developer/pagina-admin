                ...
                lista_grid_compras && lista_grid_compras.length > 0 && view_compra === 'grid' ? (
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    compras [(4 * numcom)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardCompra compra={compras[(4 * numcom)]} key={(4 * numcom)} index={(4 * numcom)} proporcional={proporcional} view_compra={view_compra}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    compras [((4 * numcom) + 1)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardCompra compra={compras[((4 * numcom) + 1)]} key={((4 * numcom) + 1)} index={((4 * numcom) + 1)} proporcional={proporcional} view_compra={view_compra}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    compras [((4 * numcom) + 2)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardCompra compra={compras[((4 * numcom) + 2)]} key={((4 * numcom) + 2)} index={((4 * numcom) + 2)} proporcional={proporcional} view_compra={view_compra}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    compras [((4 * numcom) + 3)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardCompra compra={compras[((4 * numcom) + 3)]} key={((4 * numcom) + 3)} index={((4 * numcom) + 3)} proporcional={proporcional} view_compra={view_compra}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                    ...
                    lista_compras && lista_compras.length > 0 && view_compra === 'lista' ? (
                        lista_compras.map ((compra, numcom) => {
                            return (
                                <CardCompra compra={compra} key={numcom} index={numcom} proporcional={proporcional} view_compra={view_compra}/>
                            )
                        })
                ) : null
            }   
