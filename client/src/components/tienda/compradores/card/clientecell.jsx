...
export default function CardClienteCell ({proporcional, index, cliente, view_cliente}) {
        ...
        <div key={index} style={{width: '100%', height: '100%'}}>
            {
                view_cliente === 'grid' ? (
                    ...
                    <div key={index} className='rounded' style={{width: '100%', height: 120 / proporcional, 
                            background: over_card ? 'rgba(244, 244, 244, 1)' : 'rgba(244, 244, 244, 0.6)', 
                            borderBottom: '1px solid #28a745'}}>
                        <div style={{width: '100%', height: 120 / proporcional, padding: 10 / proporcional, cursor: 'pointer'}}
                            onMouseOver={() => setOverCard(true)} onMouseLeave={() => setOverCard(false)}>
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 100 / proporcional}}>
                                <div style={{width: '90%', height: 100 / proporcional}}>
                                ...
                                <div className='d-flex justify-content-end' style={{width: '10%', height: 100 / proporcional, padding: 30 / proporcional}}>
                                    <img src={mouse_view ? view_select : view} style={{width: 40 / proporcional, height: 40 / proporcional, 
