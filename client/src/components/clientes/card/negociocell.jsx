...
export default function CardNegocioCell ({proporcional, index, negocio, view_clientes}) {
                ...
                view_clientes === 'grid' || view_clientes === '' ? (
                    ...
                    <div key={index} className='rounded' style={{width: '100%', height: 100 / proporcional, 
                        ...
                        <div style={{width: '100%', height: 100 / proporcional, padding: 10 / proporcional, cursor: 'pointer'}}
                            onMouseOver={() => setOverCard(true)} onMouseLeave={() => setOverCard(false)}>
                            <div className='d-flex justify-content-bee' style={{width: '100%', height: 80 / proporcional}}>
                                <div style={{width: '90%', height: 80 / proporcional}}>
                                ...
                                <div className='d-flex justify-content-end' style={{width: '10%', height: 80 / proporcional,
