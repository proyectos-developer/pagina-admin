        ...
        <div className='position-relative' style={{width: '100%', paddingTop: 40 / proporcional, paddingBottom : 40 / proporcional}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 100 / proporcional,
                ...
                <div className='d-flex justify-content-end' style={{width: '30%', height: 90 / proporcional}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 90 / proporcional}}>
                        <p style={{fontSize: 14 / proporcional, lineHeight: `${90 / proporcional}px`, marginBottom: 0 / proporcional, 
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_proyectos && lista_proyectos.length > 0 ? (
                        lista_proyectos.map ((proyecto, index) => {
                            return (
                                <CardProyectoCell proporcional={proporcional} key={index} index={index} proyecto={proyecto}/>
                            )
                        })
                    ) : null
                }
