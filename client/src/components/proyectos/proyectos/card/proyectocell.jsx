...
import { set_confirmacion_eliminacion, set_data_editable, set_data_proyecto} from '../../../../redux/actions/data'
...
export default function CardProyectoCell ({proporcional, index, proyecto}) {
    ...
    useEffect(() => {
        if (confirmacion_eliminacion.confirmacion){
            ...
            dispatch(proyectosdata(proyectosConstants(confirmacion_eliminacion.id, 0, 0, 0, 0, 0, 16, {}, false).delete_proyecto))
        }
    ...
    const ir_navegacion_proyecto = () => {
        ...
        navigate (`/panel/proyectos/proyectos/proyecto/${proyecto.id}`)
    }
    ...
    return (
        <div key={index} className='rounded' style={{width: '100%', height: 'auto', 
            ...
            <div style={{width: '100%', height: 'auto', padding: 5 / proporcional, cursor: 'pointer'}}
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 90 / proporcional}}>
                    <div className='d-flex justify-content-between' style={{width: '70%', height: 90 / proporcional}}>
                        <div className='' style={{width: '100%', height: 90 / proporcional}}>
                            <div className='' style={{width: '100%', height: 30 / proporcional}}>
                                <p style={{fontSize: 16 / proporcional, lineHeight: `${30 / proporcional}px`, marginBottom: 0 / proporcional, 
                                    ...
                                    <span style={{color: '#007bff', fontSize: 16 / proporcional}}>{proyecto.cliente}</span>
                                </p>
                            </div>
                            <div className='' style={{width: '100%', height: 30 / proporcional}}>
                                <p style={{fontSize: 16 / proporcional, lineHeight: `${30 / proporcional}px`, marginBottom: 0 / proporcional, 
                                    color: 'rgb(89, 89, 89)', fontFamily: 'Merriweather', fontWeight: 600, textAlign: 'left'}}>
                                    <span style={{color: '#007bff', fontSize: 16 / proporcional}}>{proyecto.tipo_proyecto}</span>
                                </p>
                            </div>
                            <div className='' style={{width: '100%', height: 30 / proporcional}}>
                                <p style={{fontSize: 16 / proporcional, lineHeight: `${30 / proporcional}px`, marginBottom: 0 / proporcional, 
                                    color: 'rgb(89, 89, 89)', fontFamily: 'Merriweather', fontWeight: 600, textAlign: 'left'}}>
                                    <span style={{color: '#007bff', fontSize: 16 / proporcional}}>{proyecto.nombre_proyecto.slice(0, 25)}...</span>
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className='d-flex justify-content-end' style={{width: '30%', height: 90 / proporcional,
