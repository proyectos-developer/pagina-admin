...
import NuevoNegocioTablet from './menu/nuevonegociotablet.jsx'
import UpdateNegocioTablet from './menu/updatenegociotablet.jsx'
...
export default function NegociosPanelTablet ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_negocio_guardado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevoNegocioTablet proporcional={proporcional} negocio={negocio}/>
            ...
            }
            {
                show_negocio_actualizado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '60%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateNegocioTablet proporcional={proporcional} negocio={negocio}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
