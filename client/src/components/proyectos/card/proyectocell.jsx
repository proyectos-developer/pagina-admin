...
export default function CardProyectoCell ({proporcional, index, proyecto, view_proyecto}) {
    ...
    const ver_proyecto = () => {
        ...
        navigate (`/panel/proyectos/proyecto/${proyecto.nombre_proyecto.replace(' ', '-')}/${proyecto.id}`)
    }
                                ...
                                <div style={{width: '75%', height: 60 / proporcional}}>
                                    <div className='' style={{width: '100%', height: 40 / proporcional}}>
                                        <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                            ...
                                            <span style={{fontSize: 18 / proporcional, color: 'rgb(89, 89, 89)'}}>
                                                <strong>{index + 1}. </strong></span> <span style={{fontSize: 18 / proporcional, color: 'rgb(89, 89, 89)'}}>
                                            {proyecto.nombre_proyecto.slice(0, 22)}...</span>
                                        </h4>
                                    </div>
                                    <div className='' style={{width: '100%', height: 20 / proporcional}}>
                                        <h6 style={{fontSize: 14 / proporcional, lineHeight: `${20 / proporcional}px`, marginBottom: 0 / proporcional, 
                                            color: '#007BFF', fontFamily: 'Merriweather', fontWeight: 600, textAlign: 'left'}}>
                                            {proyecto.tipo_proyecto} <span style={{fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)'}}>
                                            {proyecto.cliente}</span>
                                        </h6>
                                    </div>
                                </div>
