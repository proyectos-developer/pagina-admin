...
import {set_data_gestion_riesgos, set_datos_paso_gestion_proyectos, set_error_message}  from '../../../../../redux/actions/data'
...
export default function DatosRiesgosProyecto ({proporcional, id}) {
    ...
    const { get_tareas_proyectos_filter, new_riesgo_proyecto} = useSelector(({gestionproyectos_data}) => gestionproyectos_data)
    ...
    useEffect(() => {
        ...
        }if (get_tareas_proyectos_filter && get_tareas_proyectos_filter.success === false && get_tareas_proyectos_filter.error){
            ...
            <div className='position-relative' style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                <span className='position-absolute'  
                    style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                        left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                        background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
                        <strong>Descripción del riesgo</strong></span>
                <textarea 
                    id='riesgo_proyecto'
                    type='default'
                    rows={3}
            ...
            <div className='position-relative' style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                <span className='position-absolute'  
                    style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                        left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                        background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
                        <strong>Mitigación del riesgo</strong></span>
                <textarea 
