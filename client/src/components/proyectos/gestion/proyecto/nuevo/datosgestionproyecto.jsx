...
export default function DatosGestionProyecto ({proporcional}) {
    ...
    const {data_gestion_informacion, datos_paso_gestion_proyectos} = useSelector(({data_actions}) => data_actions)
        ...
        <div className='' style={{width: '100%', height: 'auto', paddingTop: 40 / proporcional, paddingBottom : 40 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                ...
                <div style={{width: '48%', height: 'auto'}}>
                    {
                        nuevo_cliente ? (
                            <div className='position-relative d-flex justify-content-between' style={{width: '100%', height: 40 / proporcional, marginBottom: 16 / proporcional,
                                ...
                                <input
                                    ...
                                    style={{width: '90%', height: 38 / proporcional, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                                        fontFamily: 'Poppins, sans-serif', padding: 10 / proporcional}}
                                    placeholder='Nuevo cliente'/>
                                <img src={boton_cancelar ? cross_select : cross} style={{width: 38 / proporcional, height: 38 / proporcional,
                                        padding: 8 / proporcional}} 
                                    onMouseOver={() => setBotonCancelar(true)} onMouseLeave={() => setBotonCancelar(false)}
                                    onClick={() => {setNuevoCliente(false); setCliente('')}}/>
                                <img src={boton_save ? save_select : save} style={{width: 38 / proporcional, height: 38 / proporcional,
                                        padding: 8 / proporcional}} 
            ...
            <div className='position-relative' style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional
                ...
                <span className='position-absolute'  
                    style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                        left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                        background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
                        <strong>Descripción del proyecto</strong></span>
                <textarea 
                    id='descripcion'
                    type='default'
                    rows={3}
                ...
                <div className='position-relative' style={{width: '48%', height: 'auto', marginBottom: 16 / proporcional
                    ...
                    <span className='position-absolute'  
                        ...
                        <input
                            ...
                            style={{width: '100%', height: 40 / proporcional, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                                    fontFamily: 'Poppins, sans-serif', padding: 10 / proporcional, 
                                    border: efecha_inicio ? '1px solid red' : '1px solid #007bff'}}
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div className='position-relative' style={{width: '32%', height: 'auto', marginBottom: 16 / proporcional
                }}>
                    <span className='position-absolute'  
                        style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                            left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                            background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
                            <strong>Estado proyecto</strong></span>
                    <select 
                ...
                <div className='position-relative' style={{width: '32%', height: 'auto', marginBottom: 16 / proporcional
                    ...
                    <span className='position-absolute'  
                        style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                            left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                            background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
                            <strong>Tipo de moneda</strong></span>
                    <select 
                ...
                <div className='position-relative' style={{width: '32%', height: 'auto', marginBottom: 16 / proporcional
                    ...
                    <span className='position-absolute'  
                        style={{lineHeight: `${14 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                            left: 10 / proporcional, top: -7 / proporcional, fontFamily: 'Poppins, sans-serif', marginBottom: 0,
                            background: 'white', paddingLeft: 5 / proporcional, paddingRight: 5 / proporcional}}>
                            <strong>Presupuesto</strong></span>
                    <input
                        autoComplete='off' 
