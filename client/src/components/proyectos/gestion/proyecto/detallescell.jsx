...
import DatosGestionProyectoCell from './detalles/datosgestionproyectocell.jsx'
import DatosTareasProyectoCell from './detalles/datostareasproyectocell.jsx'
import DatosEquipoProyectoCell from './detalles/datosequipoproyectocell.jsx'
import DatosDocumentosProyectoCell from './detalles/datosdocumentosproyectocell.jsx'
import DatosComunicacionesProyectoCell from './detalles/datoscomunicacionesproyectocell.jsx'
import DatosRiesgosProyectoCell from './detalles/datosriesgosproyectocell.jsx'
import DatosKpisProyectoCell from './detalles/datoskpisproyectocell.jsx'
...
export default function DetallesGestionProyectoCell ({proporcional}) {
            ...
            <div className='' style={{width: '100%', height: 'auto'}}>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    ...
                    <p style={{fontSize: 18 / proporcional, lineHeight: `${30 / proporcional}px`, color: 'rgb(89, 89, 89)',
                            fontWeight: 500, fontFamily: 'Poppins, sans, serif', cursor: 'pointer',
                        marginRight: 10 / proporcional}}>
                        / {gestion_proyecto.nombre_proyecto}
                    </p>
            </div>
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        {
                            datos_paso_gestion_proyectos === 'gestion' ? (
                                <DatosGestionProyectoCell proporcional={proporcional}/>
                            ) : datos_paso_gestion_proyectos === 'tareas' ? (
                                <DatosTareasProyectoCell proporcional={proporcional} id={id_proyecto}/>
                            ) : datos_paso_gestion_proyectos === 'equipo' ? (
                                <DatosEquipoProyectoCell proporcional={proporcional} id={id_proyecto}/>
                            ) : datos_paso_gestion_proyectos === 'documentos' ? (
                                <DatosDocumentosProyectoCell proporcional={proporcional} id={id_proyecto}/>
                            ) : datos_paso_gestion_proyectos === 'comunicaciones' ? (
                                <DatosComunicacionesProyectoCell proporcional={proporcional} id={id_proyecto}/>
                            ) : datos_paso_gestion_proyectos === 'riesgos' ? (
                                <DatosRiesgosProyectoCell proporcional={proporcional} id={id_proyecto}/>
                            ) : datos_paso_gestion_proyectos === 'kpis' ? (
                                <DatosKpisProyectoCell proporcional={proporcional} id={id_proyecto}/>
                            ) : null
                        }
                    </div>
                </div>
