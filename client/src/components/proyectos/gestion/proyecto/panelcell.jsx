...
import NuevaGestionCell from './menu/nuevagestioncell.jsx'
import UpdateGestionCell from './menu/updategestioncell.jsx'
...
export default function GestionProyectosPanelCell ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_gestion_guardada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevaGestionCell proporcional={proporcional} gestion_proyecto={gestion_proyecto}/>
            ...
            }
            {
                show_gestion_actualizada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '90%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateGestionCell proporcional={proporcional} gestion_proyecto={gestion_proyecto}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
