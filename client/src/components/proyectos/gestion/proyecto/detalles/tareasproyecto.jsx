...
import CardDependencia from '../card/dependencia.jsx'

export default function DetallesTareasProyecto({proporcional}) {
    ...
    return (
        <div style={{width: '100%', height: 'auto', padding: 50 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div style={{width: '40%', height: 'auto', borderRight: '1px solid #4a4a4a', paddingRight: 50 / proporcional}}>
                    ...
                    <div className='' style={{width: '100%', height: '100%', marginBottom: 16 / proporcional}}>
                        {
                            lista_dependencias && lista_dependencias.length > 0 ? (
                                lista_dependencias.map ((tarea, index) => {
                                    return (
                                        <CardDependencia proporcional={proporcional} key={index} index={index} tarea={tarea}/>
                                    )
                                })
                            ) : null
                        }
                    ...
                    <div className='d-flex justify-content-start' style={{width: '100%', height: 'auto'}}>
                        <div className={boton_nuevo ? 'shadow rounded' : 'shadow-sm rounded'} 
                            style={{width: '50%', height: 50 / proporcional, background: '#007BFF', cursor: 'pointer'}}
