...
export default function DetallesTrabajadoresProyectoCell({proporcional}) {
    ...
    const {get_personal_filter} = useSelector(({personal_filter}) => personal_filter)

    useEffect(() => {
        dispatch (gestionproyectosdata(gestionproyectosConstants(0, 0, 'proyecto', location.pathname.split ('/')[6], 0, 0, 0, 0, 100, {}, false).get_trabajadores_proyecto_filter))
    }, [])
    ...
    const buscar_trabajadores = () => {
        if (search_trabajador !== ''){
            dispatch(personaldata(personalConstants(0, search_trabajador, 0, 0, 0, 0, 0, 100, {}, false).get_personal_filter))
        }
    }
    ...
    const actualizar_trabajador = () => {
        if (tarea === '' && id_trabajador === ''){
            ...
            dispatch(gestionproyectosdata(gestionproyectosConstants(id_trabajador, location.pathname.split('/')[6], 0, 0, 0, 0, 0, 0, 0, data_trabajador, false).update_trabajador_proyecto))
        }
    }
    ...
    return (
        <div style={{width: '100%', height: 'auto', padding: 20 / proporcional, paddingTop: 50 / proporcional, paddingBottom: 50 / proporcional}}>
            <div className='' style={{width: '100%', height: 'auto'}}>
                    ...
                    <div className='' style={{width: '100%', height: '100%', marginBottom: 16 / proporcional}}>
                        {
                            lista_equipo && lista_equipo.length > 0 ? (
                                lista_equipo.map ((trabajador, index) => {
                                    return (
                                        <CardTrabajadorCell proporcional={proporcional} key={index} index={index} trabajador={trabajador}/>
                                    )
                                })
                            ) : null
                        }
                ...
                {
                    (get_trabajador_proyecto && get_trabajador_proyecto.trabajador_proyecto) || nuevo_trabajador ? ( 
                                        ...
                                        <div style={{width: '100%', height: 'auto', marginBottom: 16 / proporcional}}>
                                            ...
                                            <div className='d-flex justify-content-between rounded' style={{width: '100%', height: 50 / proporcional,
                                                ...
                                                <input
                                                    ...
                                                    style={{width: '90%', height: 100 / proporcional, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
