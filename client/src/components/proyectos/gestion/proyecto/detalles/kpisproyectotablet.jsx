...
import CardKpiTablet from '../card/kpitablet.jsx'
import axios from 'axios'
import { constantes } from '../../../../../uri/constantes.js'

export default function DetallesKpisProyectoTablet({proporcional}) {
                    ...
                    <div className='' style={{width: '100%', height: '77%', marginBottom: 16 / proporcional}}>
                        {
                            lista_kpis && lista_kpis.length > 0 ? (
                                lista_kpis.map ((kpi, index) => {
                                    return (
                                        <CardKpiTablet proporcional={proporcional} key={index} index={index} kpi={kpi}/>
                                    )
                                })
                            ) : null
                        }
