...
import CardKpiCell from '../card/kpicell.jsx'
import axios from 'axios'
import { constantes } from '../../../../../uri/constantes.js'

export default function DetallesKpisProyectoCell({proporcional}) {
                    ...
                    <div className='' style={{width: '100%', height: '77%', marginBottom: 16 / proporcional}}>
                        {
                            lista_kpis && lista_kpis.length > 0 ? (
                                lista_kpis.map ((kpi, index) => {
                                    return (
                                        <CardKpiCell proporcional={proporcional} key={index} index={index} kpi={kpi}/>
                                    )
                                })
                            ) : null
                        }
