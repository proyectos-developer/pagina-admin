...
import CardDocumento from '../card/documento.jsx'

export default function DetallesDocumentosProyecto({proporcional}) {
                    ...
                    <div className='' style={{width: '100%', height: '100%', marginBottom: 16 / proporcional}}>
                        {
                            lista_documentos && lista_documentos.length > 0 ? (
                                lista_documentos.map ((documento, index) => {
                                    return (
                                        <CardDocumento proporcional={proporcional} key={index} index={index} documento={documento}/>
                                    )
                                })
                            ) : null
                        }
