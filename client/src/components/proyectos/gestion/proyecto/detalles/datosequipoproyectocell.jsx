...
export default function DatosEquipoProyectoCell ({proporcional}) {
        ...
        <div className='' style={{width: '100%', height: 'auto', paddingTop: 40 / proporcional, paddingBottom : 40 / proporcional}}>
            <div className='' style={{width: '100%', height: 'auto'}}>
                    ...
                    <div className='overflow-auto' style={{width: '100%', height: 'auto', maxHeight: 300 / proporcional, marginBottom: 16 / proporcional}}>
                        {
                            lista_equipos_proyecto && lista_equipos_proyecto.length > 0 ? (
                                lista_equipos_proyecto.map ((equipo, index) => {
                                    return (
                                        <CardTrabajadorCell proporcional={proporcional} equipo={equipo} key={index} index={index}/>
                                    )
                                })
                            ) : (
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    <div className='' style={{width: '100%', height: 'auto'}}>
                        <div style={{width: '100%', height: 'auto', border: '1px solid #007bff', marginBottom: 16 / proporcional}}>
                            <input
