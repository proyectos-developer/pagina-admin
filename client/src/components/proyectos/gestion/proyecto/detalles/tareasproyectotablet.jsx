...
import CardDependenciaTablet from '../card/dependenciatablet.jsx'

export default function DetallesTareasProyectoTablet({proporcional}) {
                    ...
                    <div className='' style={{width: '100%', height: '100%', marginBottom: 16 / proporcional}}>
                        {
                            lista_dependencias && lista_dependencias.length > 0 ? (
                                lista_dependencias.map ((tarea, index) => {
                                    return (
                                        <CardDependenciaTablet proporcional={proporcional} key={index} index={index} tarea={tarea}/>
                                    )
                                })
                            ) : null
                        }
