...
export default function DatosGestionProyectoCell ({proporcional}) {
        ...
        <div className='' style={{width: '100%', height: 'auto', paddingTop: 40 / proporcional, paddingBottom : 40 / proporcional}}>
            <div className='' style={{width: '100%', height: 'auto'}}>
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    {
                        nuevo_cliente ? (
                            <div className='d-flex' style={{width: '100%', height: 50 / proporcional, border: '1px solid #007BFF', marginBottom: 16 / proporcional}}>
                                <input
                                    disabled={!editar_informacion}
                                    autoComplete='off' 
                                    type='default'
