...
export default function DatosEquipoProyecto ({proporcional}) {
        ...
        <div className='' style={{width: '100%', height: 'auto', paddingTop: 40 / proporcional, paddingBottom : 40 / proporcional}}>
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div className='' style={{width: '24%', minHeight: '100%'}}>
                    <div className='overflow-auto' style={{width: '100%', minHeight: '87%', marginBottom: 16 / proporcional}}>
                        {
                            lista_equipos_proyecto && lista_equipos_proyecto.length > 0 ? (
                                lista_equipos_proyecto.map ((equipo, index) => {
                                    return (
                                        <CardTrabajador proporcional={proporcional} equipo={equipo} key={index} index={index}/>
                                    )
                                })
                            ) : (
