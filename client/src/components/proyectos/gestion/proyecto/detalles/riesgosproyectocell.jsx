...
import CardRiesgoCell from '../card/riesgocell.jsx'

export default function DetallesRiesgosProyectoCell({proporcional}) {
                    ...
                    <div className='' style={{width: '100%', height: '100%', marginBottom: 16 / proporcional}}>
                        {
                            lista_riesgos && lista_riesgos.length > 0 ? (
                                lista_riesgos.map ((riesgo, index) => {
                                    return (
                                        <CardRiesgoCell proporcional={proporcional} key={index} index={index} riesgo={riesgo}/>
                                    )
                                })
                            ) : null
                        }
