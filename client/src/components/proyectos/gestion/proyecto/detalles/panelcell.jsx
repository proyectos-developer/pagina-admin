...
export default function DetallesGestionProyectoPanelCell({proporcional}) {
    ...
    const {get_informe_proyecto} = useSelector(({gestionproyectos_data}) => gestionproyectos_data)
    ...
    return (
        <div className='position-relative' style={{width: '100%', height: '100%', paddingLeft: open_menu_lateral ? 20 / proporcional : 60 / proporcional,
            ...
            <div className='' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                ...
                <div className='rounded shadow' style={{width: '100%', height: '100%', padding: 20 / proporcional,
                    ...
                    </div>
                    {
                        show_cliente ? (
                            <div className='' style={{width: '100%', height: 'auto'}}>
                                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', paddingTop: 16 / proporcional, marginBottom: 16 / proporcional}}>
                                    <div style={{width: 96 / proporcional, height: 'auto', marginRight: 16 / proporcional}}>
                                        <div className='rounded-circle' style={{width: 96 / proporcional, height: 96 / proporcional, border: '1px solid #4a4a4a'}}>
                                            {
                                                url_logo !== '' ? (
                                                    <img className='rounded-circle' src={url_logo} 
                                                        style={{width: 94 / proporcional, height: 94 / proporcional}}/>
                                                ) : null
                                            }
                                        </div>
                                    </div>
            ...
            <div styl={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', borderBottom: '2px solid #00b7ff', marginBottom: 16 / proporcional}}>
                    <div style={{width: '50%', height: 60 / proporcional, border: menu_agregar === 'tareas' ? '2px solid #00b7ff' : '2px solid white',
                        ...
                        <p style={{fontSize: 20 / proporcional, lineHeight: `${60 / proporcional}px`, color: menu_agregar === 'tareas' ? '#007bff' : '#4a4a4a',
                            ...
                            onClick={() => {setMenuAgregar('tareas'); navigate ('tareas'); setShowCliente(false); setShowProyecto(false)}}>Tareas</p>
                    </div>
                    <div style={{width: '50%', height: 60 / proporcional, border: menu_agregar === 'trabajadores' ? '2px solid #00b7ff' : '2px solid white',
                        ...
                        <p style={{fontSize: 20 / proporcional, lineHeight: `${50 / proporcional}px`, color: menu_agregar === 'trabajadores' ? '#007bff' : '#4a4a4a',
                            ...
                            onClick={() => {setMenuAgregar('trabajadores'); navigate ('trabajadores'); setShowCliente(false); setShowProyecto(false)}}>Trabajadores</p>
                    </div>
                </div>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', borderBottom: '2px solid #00b7ff', marginBottom: 16 / proporcional}}>
                    <div style={{width: '50%', height: 60 / proporcional, border: menu_agregar === 'documentos' ? '2px solid #00b7ff' : '2px solid white',
                        ...
                        <p style={{fontSize: 20 / proporcional, lineHeight: `${50 / proporcional}px`, color: menu_agregar === 'documentos' ? '#007bff' : '#4a4a4a',
                            ...
                            onClick={() => {setMenuAgregar('documentos'); navigate ('documentos'); setShowCliente(false); setShowProyecto(false)}}>Documentos</p>
                    </div>
                    <div style={{width: '50%', height: 60 / proporcional, border: menu_agregar === 'comunicaciones' ? '2px solid #00b7ff' : '2px solid white',
                        ...
                        <p style={{fontSize: 20 / proporcional, lineHeight: `${50 / proporcional}px`, color: menu_agregar === 'comunicaciones' ? '#007bff' : '#4a4a4a',
                            ...
                            onClick={() => {setMenuAgregar('comunicaciones'); navigate ('comunicaciones'); setShowCliente(false); setShowProyecto(false)}}>Comunicaciones</p>
                    </div>
                </div>
                <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', borderBottom: '2px solid #00b7ff', marginBottom: 16 / proporcional}}>
                    <div style={{width: '50%', height: 60 / proporcional, border: menu_agregar === 'riesgos' ? '2px solid #00b7ff' : '2px solid white',
                        ...
                        <p style={{fontSize: 20 / proporcional, lineHeight: `${50 / proporcional}px`, color: menu_agregar === 'riesgos' ? '#007bff' : '#4a4a4a',
                            ...
                            onClick={() => {setMenuAgregar('riesgos'); navigate ('riesgos'); setShowCliente(false); setShowProyecto(false)}}>Riesgos</p>
                    </div>
                    <div style={{width: '50%', height: 60 / proporcional, border: menu_agregar === 'kpis' ? '2px solid #00b7ff' : '2px solid white',
                        ...
                        <p style={{fontSize: 20 / proporcional, lineHeight: `${50 / proporcional}px`, color: menu_agregar === 'kpis' ? '#007bff' : '#4a4a4a',
                            ...
                            onClick={() => {setMenuAgregar('kpis'); navigate ('kpis'); setShowCliente(false); setShowProyecto(false)}}>KPIS</p>
                    </div>
                </div>
            </div>
