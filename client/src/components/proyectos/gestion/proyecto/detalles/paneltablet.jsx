...
export default function DetallesGestionProyectoPanelTablet({proporcional}) {
    ...
    return (
        <div className='position-relative' style={{width: '100%', height: '100%', paddingLeft: open_menu_lateral ? 60 / proporcional : 100 / proporcional,
