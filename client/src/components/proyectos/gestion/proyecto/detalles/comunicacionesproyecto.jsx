...
import CardComunicacion from '../card/comunicacion.jsx'

export default function DetallesComunicacionesProyecto({proporcional}) {
                    ...
                    <div className='' style={{width: '100%', height: '100%', marginBottom: 16 / proporcional}}>
                        {
                            lista_comunicaciones && lista_comunicaciones.length > 0 ? (
                                lista_comunicaciones.map ((comunicacion, index) => {
                                    return (
                                        <CardComunicacion proporcional={proporcional} index={index} key={index} comunicacion={comunicacion}/>
                                    )
                                })
                            ) : null
                        }
