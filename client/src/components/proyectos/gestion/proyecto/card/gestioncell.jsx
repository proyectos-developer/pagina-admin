...
export default function CardGestionProyectoCell ({proporcional, index, proyecto}) {
                    ...
                    <div className='' style={{width: '70%', height: 60 / proporcional}}>
                        <div className='' style={{width: '100%', height: 30 / proporcional}}>
                            <p style={{fontSize: 16 / proporcional, lineHeight: `${30 / proporcional}px`, marginBottom: 0 / proporcional, 
                                ...
                                <span style={{color: '#007bff', fontSize: 16 / proporcional}}>{proyecto.nombre_proyecto.slice(0,25)}... ({proyecto.prioridad})</span>
                            </p>
                        </div>
