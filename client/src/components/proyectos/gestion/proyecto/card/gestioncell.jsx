...
export default function CardGestionProyectoCell ({proporcional, index, gestion_proyecto, view_gestion}) {
                    ...
                    <div key={index} className='rounded' style={{width: '100%', height: 100 / proporcional, 
                        ...
                        <div style={{width: '100%', height: 100 / proporcional, padding: 10 / proporcional, cursor: 'pointer'}}
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 80 / proporcional}}>
                                <div style={{width: '75%', height: 80 / proporcional }}>
                                    <div className='' style={{width: '100%', height: 40 / proporcional}}>
                                        <h4 style={{fontSize: 14 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                            ...
                                            <span style={{color: '#007bff', fontSize: 16 / proporcional}}>{gestion_proyecto.nombre_proyecto.slice(0, 33)}...</span>
                                        </h4>
                                    </div>
                                    <div className='' style={{width: '100%', height: 20 / proporcional}}>
                                ...
                                <div className='d-flex justify-content-end' style={{width: '25%', height: 80 / proporcional,
                                        padding: 20 / proporcional, paddingRight: 10, paddingLeft: 30 / proporcional
                                }}>
                                    <img src={mouse_view ? view_select : view} style={{width: 40 / proporcional, height: 40 / proporcional, 
