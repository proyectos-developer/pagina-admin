...
export default function DetallesProyecto ({proporcional}) {
    ...
    useEffect(() => {
        if (data_proyecto.nombre_proyecto === undefined){
            dispatch(proyectosdata(proyectosConstants(location.pathname.split ('/')[5], 0, 0, 0, 0, 0, 0, 0, 0, 0, 16, {}, false).get_proyecto))
        }else{
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: '100%'}}>
                <div style={{width: '80%', height: '100%'}}>
                    <div className='d-flex justify-content-center' 
                        ...
                        <div className='rounded-circle' style={{width:  290 / proporcional, height: 290 / proporcional,
