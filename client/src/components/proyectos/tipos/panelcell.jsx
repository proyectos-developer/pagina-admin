...
import NuevoTipoProyectoCell from './menu/nuevotipoproyectocell.jsx'
import UpdateTipoProyectoCell from './menu/updatetipoproyectocell.jsx'
...
export default function TiposProyectosPanelCell ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_tipo_proyecto_guardado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevoTipoProyectoCell proporcional={proporcional} tipo_proyecto={tipo_proyecto}/>
            ...
            }
            {
                show_tipo_proyecto_actualizado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '90%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateTipoProyectoCell proporcional={proporcional} tipo_proyecto={tipo_proyecto}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
