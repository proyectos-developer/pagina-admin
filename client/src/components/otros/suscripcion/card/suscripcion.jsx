...
export default function CardSuscripcion ({proporcional, index, suscripcion, view_suscripcion}) {
    ...
    const ver_suscripcion = () => {
        if (cliente && cliente.nombres){
            ...
            navigate (`/panel/tienda/compradores/comprador/${cliente.apellidos}/${cliente.usuario}`)
        }
    }
