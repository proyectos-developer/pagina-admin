...
export default function CardSuscripcionCell ({proporcional, index, suscripcion, view_suscripcion}) {
    ...
    const ver_suscripcion = () => {
        if (cliente && cliente.nombres){
            ...
            navigate (`/panel/otros/compradores/comprador/${cliente.apellidos}/${cliente.usuario}`)
        }
    }
