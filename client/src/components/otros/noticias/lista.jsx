...
export default function ListaNoticias ({proporcional}) {
                ...
                lista_grid_noticias && lista_grid_noticias.length > 0 && view_noticia === 'grid' ? (
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    noticias [(4 * numnot)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardNoticia noticia={noticias[(4 * numnot)]} key={(4 * numnot)} index={(4 * numnot)} proporcional={proporcional} view_noticia={view_noticia}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    noticias [((4 * numnot) + 1)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardNoticia noticia={noticias[((4 * numnot) + 1)]} key={((4 * numnot) + 1)} index={((4 * numnot) + 1)} proporcional={proporcional} view_noticia={view_noticia}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    noticias [((4 * numnot) + 2)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardNoticia noticia={noticias[((4 * numnot) + 2)]} key={((4 * numnot) + 2)} index={((4 * numnot) + 2)} proporcional={proporcional} view_noticia={view_noticia}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    noticias [((4 * numnot) + 3)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardNoticia noticia={noticias[((4 * numnot) + 3)]} key={((4 * numnot) + 3)} index={((4 * numnot) + 3)} proporcional={proporcional} view_noticia={view_noticia}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                    ...
                    lista_noticias && lista_noticias.length > 0 && view_noticia === 'lista' ? (
                        lista_noticias.map ((noticia, numnot) => {
                            return (
                                <CardNoticia noticia={noticia} key={numnot} index={numnot} proporcional={proporcional} view_noticia={view_noticia}/>
                            )
                        })
                ) : null
            }                  
