...
export default function DetallesNoticiaCell ({proporcional}) {
    ...
    useEffect(() => {
        if (data_noticia.fecha === undefined){
            dispatch(noticiasdata(noticiasConstants(location.pathname.split ('/')[6], 0, 0, 0, 0, 0, 16, {}, false).get_noticia))
        }else{
            ...
            <div className='d-flex justify-content-center' style={{width: '100%', height: '100%'}}>
                <div style={{width: '100%', height: '100%'}}>
                    <div className='d-flex justify-content-center' 
                        ...
                        <div className='rounded-circle' style={{width:  350 / proporcional, height: 350 / proporcional,
                            border: '1px solid #4a4a4a'}}>
                            {
                                url_foto !== '' ? (
                                    <img className='rounded-circle' src={url_foto} 
                                    style={{width: 348 / proporcional, height: 348 / proporcional}}/>
                                ) : null
                            }
                        </div>
                    </div>
