                ...
                lista_grid_areas_empresa && lista_grid_areas_empresa.length > 0 && view_area_empresa === 'grid' ? (
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    areas_empresa [(4 * numarea)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardAreaEmpresa area_empresa={areas_empresa[(4 * numarea)]} key={(4 * numarea)} index={(4 * numarea)} proporcional={proporcional} view_area_empresa={view_area_empresa}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    areas_empresa [((4 * numarea) + 1)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardAreaEmpresa area_empresa={areas_empresa[((4 * numarea) + 1)]} key={((4 * numarea) + 1)} index={((4 * numarea) + 1)} proporcional={proporcional} view_area_empresa={view_area_empresa}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    areas_empresa [((4 * numarea) + 2)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardAreaEmpresa area_empresa={areas_empresa[((4 * numarea) + 2)]} key={((4 * numarea) + 2)} index={((4 * numarea) + 2)} proporcional={proporcional} view_area_empresa={view_area_empresa}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                }
                                {
                                    areas_empresa [((4 * numarea) + 3)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardAreaEmpresa area_empresa={areas_empresa[((4 * numarea) + 3)]} key={((4 * numarea) + 3)} index={((4 * numarea) + 3)} proporcional={proporcional} view_area_empresa={view_area_empresa}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                    ...
                    lista_areas_empresa && lista_areas_empresa.length > 0 && view_area_empresa === 'lista' ? (
                        lista_areas_empresa.map ((area_empresa, numarea) => {
                            return (
                                <CardAreaEmpresa area_empresa={area_empresa} key={numarea} index={numarea} proporcional={proporcional} view_area_empresa={view_area_empresa}/>
                            )
                        })
                ) : null
            }                  
