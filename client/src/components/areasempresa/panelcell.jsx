...
import NuevaAreaEmpresaCell from './menu/nuevaareaempresacell.jsx'

import { Outlet, useNavigate} from 'react-router-dom'
import { useDispatch, useSelector } from 'react-redux'
import { set_data_areas_empresa } from '../../redux/actions/data.js'

export default function AreasEmpresaPanelCell ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_area_empresa ? (
                    <div className='position-fixed end-0 shadow overflow-auto' 
                        ...
                        <NuevaAreaEmpresaCell proporcional={proporcional} area_empresa={area_empresa}/>
