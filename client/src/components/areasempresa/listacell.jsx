...
export default function ListaAreasEmpresaCell ({proporcional}) {
    ...
    const dividir_nro_columnas = (data_areas_empresa) => {
        ...
        setListaGridAreasEmpresa (data_areas_empresa.areas_empresa)
                        ...
                        return (
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                <div style={{width: '90%', height: 'auto'}}>
                                    <CardAreaEmpresaCell area_empresa={area_empresa} key={numarea} index={numarea} proporcional={proporcional} view_area_empresa={view_area_empresa}/>
                                </div>
                            </div>
                        )
                    })
