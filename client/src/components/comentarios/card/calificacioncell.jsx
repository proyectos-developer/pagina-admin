...
export default function CardCalificionCell ({proporcional, index, calificacion, view_calificacion}) {
    ...
    const ver_calificcion = () => {
        ...
        navigate (`/panel/calificaciones/producto/${calificacion.producto.replace(' ', '-')}/${calificacion.id_producto}`)
    }
