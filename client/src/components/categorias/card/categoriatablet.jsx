...
export default function CardCategoriaTablet ({proporcional, index, categoria, view_categoria}) {
    ...
    const ver_categoria = () => {
        ...
        navigate (`/panel/categorias/categoria/${categoria.categoria.replace(' ', '-')}/${categoria.id}`)
    }
                    ...
                    <div key={index} className={over_card ? 'rounded shadow-lg' : 'rounded shadow'} style={{width: '100%', height: '100%',
                        ...
                        <div style={{width: '100%', height: 'auto', padding: 20 / proporcional, cursor: 'pointer'}}>
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                ...
                                <img className='rounded-circle' src={categoria.url_foto} style={{width: 148 / proporcional, height: 148 / proporcional}}/>
                                </div>
                            </div>
                            <div style={{width: '100%', height: 'auto'}}>
                                <h4 style={{fontSize: 16 / proporcional, lineHeight: `${26 / proporcional}px`, marginBottom: 16 / proporcional, 
                                    ...
                                    Categoría: <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{categoria.categoria}</span>
                                </h4>
                            </div>
                        </div>
                        {
                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 40 / proporcional}}>
                                <div className='' style={{width: '68%', height: 40 / proporcional}}>
                                    <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                                        ...
                                        <span style={{fontSize: 18 / proporcional}}><strong>{index + 1}. </strong></span>Categoría: <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{categoria.categoria}</span>
                                    </h4>
                                </div>
