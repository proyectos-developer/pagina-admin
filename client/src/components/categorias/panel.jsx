...
import NuevaCategoria from './menu/nuevacategoria.jsx'

import { Outlet, useNavigate} from 'react-router-dom'
import { useDispatch, useSelector } from 'react-redux'
import { set_data_categoria } from '../../redux/actions/data.js'

export default function CategoriasPanel ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_categoria ? (
                    <div className='position-fixed end-0 shadow overflow-auto' 
                        ...
                        <NuevaCategoria proporcional={proporcional} categoria={categoria}/>
