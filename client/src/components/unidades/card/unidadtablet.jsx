...
export default function CardUnidadTablet ({proporcional, index, unidad, view_unidad}) {
    ...
    const ver_unidad = () => {
        ...
        navigate (`/panel/unidades/unidad/${unidad.unidad.replace(' ', '-')}/${unidad.id}`)
    }
                        ...
                        <div style={{width: '100%', height: 'auto', padding: 20 / proporcional, cursor: 'pointer'}}>
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                <div className='rounded-circle' style={{width: 150 / proporcional, height: 150 / proporcional}}>
                                    <div className='rounded-circle' src={unidad.url_imagen} style={{width: 148 / proporcional, height: 148 / proporcional}}/>
                                </div>
                            </div>
                            <div style={{width: '100%', height: 'auto'}}>
                                <h4 style={{fontSize: 16 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 16 / proporcional, 
                                    ...
                                    Unidad: <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{unidad.unidad}</span>
                                </h4>
                            </div>
                        </div>
                        {
