...
export default function ListaSubCategoriasCell ({proporcional}) {
    ...
    const dividir_nro_columnas = (data_sub_categorias) => {
        ...
        setListaGridSubCategorias (data_sub_categorias.sub_categorias)
                        ...
                        return (
                            <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                <div style={{width: '90%', height: 'auto'}}>
                                    <CardSubCategoriaCell sub_categoria={sub_categoria} key={numsub} index={numsub} proporcional={proporcional} view_subcategoria={view_subcategoria}/>
                                </div>
                            </div>
                        )
                    })
