...
export default function ListaTiposProyectos ({proporcional}) {
                ...
                lista_grid_tipos_proyectos && lista_grid_tipos_proyectos.length > 0 && view_tipo_proyecto === 'grid' || view_tipo_proyecto === '' ? (
                    lista_grid_tipos_proyectos.map ((tipo_proyecto, numneg) => {
                        return (
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    tipos_proyectos [(4 * numneg)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardTipoProyecto tipo_proyecto={tipos_proyectos[(4 * numneg)]} key={(4 * numneg)} index={(4 * numneg)} proporcional={proporcional} view_tipo_proyecto={view_tipo_proyecto}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    tipos_proyectos [((4 * numneg) + 1)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardTipoProyecto tipo_proyecto={tipos_proyectos[((4 * numneg) + 1)]} key={((4 * numneg) + 1)} index={((4 * numneg) + 1)} proporcional={proporcional} view_tipo_proyecto={view_tipo_proyecto}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    tipos_proyectos [((4 * numneg) + 2)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardTipoProyecto tipo_proyecto={tipos_proyectos[((4 * numneg) + 2)]} key={((4 * numneg) + 2)} index={((4 * numneg) + 2)} proporcional={proporcional} view_tipo_proyecto={view_tipo_proyecto}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    tipos_proyectos [((4 * numneg) + 3)] ? (
                                        <div style={{width: '24%', height: 'auto'}}>
                                            <CardTipoProyecto tipo_proyecto={tipos_proyectos[((4 * numneg) + 3)]} key={((4 * numneg) + 3)} index={((4 * numneg) + 3)} proporcional={proporcional} view_tipo_proyecto={view_tipo_proyecto}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '24%', height: 'auto'}}/>
                                    )
                    ...
                    lista_tipos_proyectos && lista_tipos_proyectos.length > 0 && view_tipo_proyecto === 'lista' ? (
                        lista_tipos_proyectos.map ((tipo_proyecto, numneg) => {
                            return (
                                <CardTipoProyecto tipo_proyecto={tipo_proyecto} key={numneg} index={numneg} proporcional={proporcional} view_tipo_proyecto={view_tipo_proyecto}/>
                            )
                        })
                ) : null
            }            
