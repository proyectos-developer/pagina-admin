                    ...
                    lista_tipo_proyectos.map ((tipo_proyecto, numtip) => {
                        return (
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    tipo_proyectos [(2 * numtip)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardTipoProyectoTablet tipo_proyecto={tipo_proyectos[(2 * numtip)]} key={(2 * numtip)} index={(2 * numtip)} proporcional={proporcional}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    tipo_proyectos [((2 * numtip) + 1)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardTipoProyectoTablet tipo_proyecto={tipo_proyectos[((2 * numtip) + 1)]} key={((2 * numtip) + 1)} index={((2 * numtip) + 1)} proporcional={proporcional}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
