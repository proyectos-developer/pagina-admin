...
import DatosPersonalesCell from './nuevo/datospersonalescell.jsx'
import DatosComunicacionUbicacionCell from './nuevo/datoscomunicacionubicacioncell.jsx'
import DatosEstudiosCell from './nuevo/datosestudioscell.jsx'
import DatosTrabajoCell from './nuevo/datostrabajocell.jsx'
import DatosSueldoCell from './nuevo/datossueldocell.jsx'
import DatosEvaluacionesCell from './nuevo/datosevaluacionescell.jsx'
...
export default function NuevoPersonalCell ({proporcional}) {
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        {
                            datos_paso_personal === 'personal' || datos_paso_personal === 'guardar' ? ( 
                                <DatosPersonalesCell proporcional={proporcional}/>
                            ) : datos_paso_personal === 'ubicacion' ? (
                                <DatosComunicacionUbicacionCell proporcional={proporcional}/>
                            ) : datos_paso_personal === 'estudios' ? (
                                <DatosEstudiosCell proporcional={proporcional}/>
                            ) : datos_paso_personal === 'trabajo' ? (
                                <DatosTrabajoCell proporcional={proporcional}/>
                            ) : datos_paso_personal === 'sueldo' ? (
                                <DatosSueldoCell proporcional={proporcional}/>
                            ) : datos_paso_personal === 'evaluacion' ? (
                                <DatosEvaluacionesCell proporcional={proporcional}/>
                            ) : null
                        }
                    </div>
                </div>
