...
export default function NuevoTrabajadorCell ({proporcional}) {
    ...
    const {new_departamento, get_departamentos_filter} = useSelector(({departamentos_filter}) => departamentos_filter)
