                            ...
                            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                                {
                                    personal [(2 * numtrab)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardTrabajadorTablet trabajador={personal[(2 * numtrab)]} key={(2 * numtrab)} index={(2 * numtrab)} proporcional={proporcional} view_trabajador={view_trabajador}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
                                ...
                                {
                                    personal [((2 * numtrab) + 1)] ? (
                                        <div style={{width: '48%', height: 'auto'}}>
                                            <CardTrabajadorTablet trabajador={personal[((2 * numtrab) + 1)]} key={((2 * numtrab) + 1)} index={((2 * numtrab) + 1)} proporcional={proporcional} view_trabajador={view_trabajador}/>
                                        </div>
                                    ) : (
                                        <div style={{width: '48%', height: 'auto'}}/>
                                    )
