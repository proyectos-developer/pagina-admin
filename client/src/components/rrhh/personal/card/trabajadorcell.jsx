        ...
        <div key={index} className='rounded' style={{width: '100%', height: '100%', 
            ...
            <div style={{width: '100%', height: 'auto', padding: 10 / proporcional, cursor: 'pointer'}}
                ...
                <div className='d-flex justify-content-between' style={{width: '100%', height: 80 / proporcional}}>
                    <div className='' style={{width: '50%', height: 80 / proporcional}}>
                        <h4 style={{fontSize: 14 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                            ...
                            <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{trabajador.apellidos} ({trabajador.estado_trabajo})</span>
                        </h4>
                        <h4 style={{fontSize: 14 / proporcional, lineHeight: `${40 / proporcional}px`, marginBottom: 0 / proporcional, 
                            color: 'rgb(89, 89, 89)', fontFamily: 'Merriweather', fontWeight: 600, textAlign: 'left'}}>
                            <span style={{color: '#007bff', fontSize: 18 / proporcional}}>{trabajador.departamento} ({trabajador.cargo})</span>
                        </h4>
                    </div>
                    <div className='d-flex justify-content-end' style={{width: '50%', height: 80 / proporcional,
                        ...
                        <div className='d-flex justify-content-center' style={{width: '13.3%', height: 40 / proporcional}}>
