...
export default function DetallesTrabajadorTablet ({proporcional}) {
    ...
    const [id_search_jefe_inmediato, setIdSearchJefeInemdiato] = useState('')
    ...
    useEffect(() => {
        if (get_departamentos_filter && get_departamentos_filter.success === true &&
                get_departamentos_filter.departamentos){
    ...
    useEffect(() => {
        if (data_personal.nombres === undefined){
            ...
            setDepartamento(data_personal.departamento)
    ...
    useEffect(() => {
        if (get_personal && get_personal.success === true && get_personal.trabajador){
            ...
            setDepartamento(get_personal.trabajador.departamento)
    ...
    const actualizar_data_personal = () => {
        window.scrollTo(0, 0)
    ...
    return (
        <div className='d-flex justify-content-center' style={{width: '100%', height: '100%', paddingLeft: open_menu_lateral ? 60 / proporcional : 100 / proporcional,
                                ...
                                editar_informacion ? (
                                    <div className='' style={{width: '100%', height: 'auto'}}>
                                        <div className={boton_actualizar ? 'shadow rounded' : 'shadow-sm rounded'} 
                                            ...
                                            onClick={() => actualizar_data_personal()}>
