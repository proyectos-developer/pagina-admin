...
import DatosPersonalesCell from './detalles/datospersonalescell.jsx'
import DatosComunicacionUbicacionCell from './detalles/datoscomunicacionubicacioncell.jsx'
import DatosEstudiosCell from './detalles/datosestudioscell.jsx'
import DatosTrabajoCell from './detalles/datostrabajocell.jsx'
import DatosSueldoCell from './detalles/datossueldocell.jsx'
import DatosEvaluacionesCell from './detalles/datosevaluacionescell.jsx'

export default function DetallesPersonalCell ({proporcional}) {
            ...
            <div className='shadow' 
                ...
                <div className='' style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-between' 
                        ...
                        <div className='' style={{width: '50%', height: 172 / proporcional }}>
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        {
                            datos_paso_personal === 'personal' && trabajador.nombres ? ( 
                                <DatosPersonalesCell proporcional={proporcional} personal={trabajador} editable={data_editable}/>
                            ) : datos_paso_personal === 'ubicacion' && trabajador.nombres ? (
                                <DatosComunicacionUbicacionCell proporcional={proporcional} personal={trabajador} editable={data_editable}/>
                            ) : datos_paso_personal === 'estudios' && trabajador.nombres ? (
                                <DatosEstudiosCell proporcional={proporcional} personal={trabajador} editable={data_editable}/>
                            ) : datos_paso_personal === 'trabajo' && trabajador.nombres ? (
                                <DatosTrabajoCell proporcional={proporcional} personal={trabajador} editable={data_editable}/>
                            ) : datos_paso_personal === 'sueldo' && trabajador.nombres ? (
                                <DatosSueldoCell proporcional={proporcional} personal={trabajador} editable={data_editable}/>
                            ) : datos_paso_personal === 'evaluacion' && trabajador.nombres ? (
                                <DatosEvaluacionesCell proporcional={proporcional} personal={trabajador} editable={data_editable}/>
                            ) : null
                        }
                    </div>
                </div>
