...
import DatosPersonales from './detalles/datospersonales.jsx'
import DatosComunicacionUbicacion from './detalles/datoscomunicacionubicacion.jsx'
import DatosEstudios from './detalles/datosestudios.jsx'
import DatosTrabajo from './detalles/datostrabajo.jsx'
import DatosSueldo from './detalles/datossueldo.jsx'
import DatosEvaluaciones from './detalles/datosevaluaciones.jsx'

export default function DetallesPersonal ({proporcional}) {
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        {
                            datos_paso_personal === 'personal' && trabajador.nombres ? ( 
                                <DatosPersonales proporcional={proporcional} personal={trabajador}/>
                            ) : datos_paso_personal === 'ubicacion' && trabajador.nombres ? (
                                <DatosComunicacionUbicacion proporcional={proporcional} personal={trabajador}/>
                            ) : datos_paso_personal === 'estudios' && trabajador.nombres ? (
                                <DatosEstudios proporcional={proporcional} personal={trabajador}/>
                            ) : datos_paso_personal === 'trabajo' && trabajador.nombres ? (
                                <DatosTrabajo proporcional={proporcional} personal={trabajador}/>
                            ) : datos_paso_personal === 'sueldo' && trabajador.nombres ? (
                                <DatosSueldo proporcional={proporcional} personal={trabajador}/>
                            ) : datos_paso_personal === 'evaluacion' && trabajador.nombres ? (
                                <DatosEvaluaciones proporcional={proporcional} personal={trabajador}/>
                            ) : null
                        }
                    </div>
                </div>
