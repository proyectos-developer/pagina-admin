...
import DatosPersonalesTablet from './nuevo/datospersonalestablet.jsx'
import DatosComunicacionUbicacionTablet from './nuevo/datoscomunicacionubicaciontablet.jsx'
import DatosEstudiosTablet from './nuevo/datosestudiostablet.jsx'
import DatosTrabajoTablet from './nuevo/datostrabajotablet.jsx'
import DatosSueldoTablet from './nuevo/datossueldotablet.jsx'
import DatosEvaluacionesTablet from './nuevo/datosevaluacionestablet.jsx'
...
export default function NuevoPersonalTablet ({proporcional}) {
            ...
            <div className='shadow' 
                ...
                <div className='' style={{width: '100%', height: 'auto'}}>
                    <div className='d-flex justify-content-between' 
                        ...
                        <div className='' style={{width: '32%', height: 196 / proporcional }}>
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        {
                            datos_paso_personal === 'personal' || datos_paso_personal === 'guardar' ? ( 
                                <DatosPersonalesTablet proporcional={proporcional}/>
                            ) : datos_paso_personal === 'ubicacion' ? (
                                <DatosComunicacionUbicacionTablet proporcional={proporcional}/>
                            ) : datos_paso_personal === 'estudios' ? (
                                <DatosEstudiosTablet proporcional={proporcional}/>
                            ) : datos_paso_personal === 'trabajo' ? (
                                <DatosTrabajoTablet proporcional={proporcional}/>
                            ) : datos_paso_personal === 'sueldo' ? (
                                <DatosSueldoTablet proporcional={proporcional}/>
                            ) : datos_paso_personal === 'evaluacion' ? (
                                <DatosEvaluacionesTablet proporcional={proporcional}/>
                            ) : null
                        }
                    </div>
                </div>
