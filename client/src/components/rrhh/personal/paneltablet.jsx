...
import UpdatePersonalTablet from './menu/updatepersonaltablet.jsx'
...
export default function PersonalPanelTablet ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_personal_guardado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevoPersonalTablet proporcional={proporcional} personal={personal}/>
            ...
            }
            {
                show_personal_actualizado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '60%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdatePersonalTablet proporcional={proporcional} personal={personal}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
