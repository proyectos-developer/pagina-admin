...
import CardEstadoTrabajoCell from './card/estadotrabajocell.jsx'
...
export default function ListaEstadoTrabajoCell ({proporcional}) {
    ...
    useEffect(() => {
        if (delete_estado && delete_estado.success === true && delete_estado.estados){
            ...
            dispatch (personaldata(personalConstants(0, 0, 0, 0, 0, 0, 0, 16, {}, personal).delete_estado))
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 160 / proporcional,
                ...
                <div className='d-flex justify-content-end' style={{width: '30%', height: 150 / proporcional}}>
                    <div className='d-flex justify-content-center' style={{width: '100%', height: 150 / proporcional}}>
                        <p style={{fontSize: 14 / proporcional, lineHeight: `${150 / proporcional}px`, marginBottom: 0 / proporcional, 
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_estados && lista_estados.length > 0 ? (
                        lista_estados.map ((estado, index) => {
                            return (
                                <CardEstadoTrabajoCell proporcional={proporcional} key={index} index={index} estado={estado}/>
                            )
                        })
                    ) : null
                }
