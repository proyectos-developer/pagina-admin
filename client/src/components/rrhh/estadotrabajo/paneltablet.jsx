...
import NuevoEstadoTrabajoTablet from './menu/nuevoestadotrabajotablet.jsx'
import UpdateEstadoTrabajoTablet from './menu/updateestadotrabajotablet.jsx'
...
export default function EstadoTrabajoPanelTablet ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_estado_guardado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevoEstadoTrabajoTablet proporcional={proporcional} estado={estado}/>
            ...
            }
            {
                show_estado_actualizado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '60%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateEstadoTrabajoTablet proporcional={proporcional} estado={estado}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
