...
import DatosTrabajadorTablet from './nuevo/datostrabajadortablet.jsx'
import DatosReemplazoTablet from './nuevo/datosreemplazotablet.jsx'
...
export default function NuevoEstadoTrabajoTablet ({proporcional}) {
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    {
                        datos_paso_estado === 'trabajador' || datos_paso_estado === 'guardar' ? ( 
                            <DatosTrabajadorTablet proporcional={proporcional}/>
                        ) : datos_paso_estado === 'reemplazo' ? (
                            <DatosReemplazoTablet proporcional={proporcional}/>
                        ) : null
                    }
                </div>
            </div>
