...
export default function DatosReemplazoCell ({proporcional, estado}) {
    ...
    useEffect(() => {
        if (update_estado_reemplazo && update_estado_reemplazo.success === true && update_estado_reemplazo.estado){
            ...
            setEditarInformacion(false)
            window.scrollTo(0, 0)
            dispatch(personaldata(personalConstants(id_estado, 0, 0, 0, 0, 0, 0, 0, {}, true).update_estado_reemplazo))
        }
