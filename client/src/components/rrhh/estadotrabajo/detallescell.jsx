...
import DatosTrabajadorCell from './detalles/datostrabajadorcell.jsx'
import DatosReemplazoCell from './detalles/datosreemplazocell.jsx'

export default function DetallesEstadoTrabajoCell ({proporcional}) {
            ...
            <div className='' style={{width: '100%', height: 'auto'}}>
                <div className='d-flex' style={{width: '100%', height: 'auto'}}>
                    ...
                    <p style={{fontSize: 18 / proporcional, lineHeight: `${30 / proporcional}px`, color: 'rgb(89, 89, 89)',
                            fontWeight: 500, fontFamily: 'Poppins, sans, serif', cursor: 'pointer',
                        marginRight: 10 / proporcional}}>
                        / {estado.nombres} {estado.apellidos}
                    </p>
            </div>
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        {
                            datos_paso_estado === 'trabajador' && estado.nombres ? ( 
                                <DatosTrabajadorCell proporcional={proporcional} estado={estado}/>
                            ) : datos_paso_estado === 'reemplazo' && estado.nombres ? (
                                <DatosReemplazoCell proporcional={proporcional} estado={estado}/>
                            ) : null
                        }
                    </div>
                </div>
