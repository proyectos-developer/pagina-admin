...
import DatosTrabajadorCell from './nuevo/datostrabajadorcell.jsx'
import DatosReemplazoCell from './nuevo/datosreemplazocell.jsx'
...
export default function NuevoEstadoTrabajoCell ({proporcional}) {
                ...
                <div style={{width: '100%', height: 'auto'}}>
                    {
                        datos_paso_estado === 'trabajador' || datos_paso_estado === 'guardar' ? ( 
                            <DatosTrabajadorCell proporcional={proporcional}/>
                        ) : datos_paso_estado === 'reemplazo' ? (
                            <DatosReemplazoCell proporcional={proporcional}/>
                        ) : null
                    }
                </div>
            </div>
