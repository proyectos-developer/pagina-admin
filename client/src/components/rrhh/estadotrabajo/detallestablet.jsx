...
import DatosTrabajadorTablet from './detalles/datostrabajadortablet.jsx'
import DatosReemplazoTablet from './detalles/datosreemplazotablet.jsx'

export default function DetallesEstadoTrabajoTablet ({proporcional}) {
                    ...
                    <div style={{width: '100%', height: 'auto'}}>
                        {
                            datos_paso_estado === 'trabajador' && estado.nombres ? ( 
                                <DatosTrabajadorTablet proporcional={proporcional} estado={estado}/>
                            ) : datos_paso_estado === 'reemplazo' && estado.nombres ? (
                                <DatosReemplazoTablet proporcional={proporcional} estado={estado}/>
                            ) : null
                        }
                    </div>
                </div>
