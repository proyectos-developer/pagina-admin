...
import CardEstadoTrabajoTablet from './card/estadotrabajotablet.jsx'
...
export default function ListaEstadoTrabajoTablet ({proporcional}) {
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_estados && lista_estados.length > 0 ? (
                        lista_estados.map ((estado, index) => {
                            return (
                                <CardEstadoTrabajoTablet proporcional={proporcional} key={index} index={index} estado={estado}/>
                            )
                        })
                    ) : null
                }
