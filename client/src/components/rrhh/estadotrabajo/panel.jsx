...
import NuevoEstadoTrabajo from './menu/nuevoestadotrabajo.jsx'
import UpdateEstadoTrabajo from './menu/updateestadotrabajo.jsx'
...
export default function EstadoTrabajoPanel ({proporcional}) {
    ...
    const {new_estado, update_estado_trabajador, update_estado_reemplazo, delete_estado} = useSelector(({personal_data}) => personal_data)
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_estado_guardado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevoEstadoTrabajo proporcional={proporcional} estado={estado}/>
            ...
            }
            {
                show_estado_actualizado ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '30%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateEstadoTrabajo proporcional={proporcional} estado={estado}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
