...
import { set_confirmacion_eliminacion, set_data_estado_reemplazo, set_datos_paso_estado } from '../../../../redux/actions/data'
...
export default function DatosReemplazoTablet ({proporcional}) {
