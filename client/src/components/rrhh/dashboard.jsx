...
export default function RrHhDashboard({proporcional}) {
    ...
    return (
        <div className='position-relative' style={{width: '100%', paddingTop: 40 / proporcional, paddingBottom : 40 / proporcional}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto', marginBottom: 32 / proporcional}}>
                <div className='rounded shadow' style={{width: '32%', height: 'auto', padding: 20 / proporcional,
                    background: 'white'
                }}>
                ...
                <div className='rounded shadow' style={{width: '66%', height: 'auto', padding: 20 / proporcional,
                    background: 'white'
                }}>
                    <h6 style={{fontSize: 16 / proporcional, lineHeight: `${24 / proporcional}px`, marginBottom: 16 / proporcional,
                        fontFamily: 'Poppins, sans-serif', color: '#28A745', fontWeight: 600}}>
            ...
            <div className='d-flex justify-content-between' style={{width: '100%', height: 'auto'}}>
                <div className='rounded shadow' style={{width: '48%', height: 'auto', padding: 20 / proporcional,
                    background: 'white'
                }}>
                    <h6 style={{fontSize: 16 / proporcional, lineHeight: `${24 / proporcional}px`, marginBottom: 16 / proporcional,
                        fontFamily: 'Poppins, sans-serif', color: '#28A745', fontWeight: 600}}>
