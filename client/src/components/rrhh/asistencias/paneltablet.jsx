...
import NuevaAsistenciaTablet from './menu/nuevaasistenciatablet.jsx'
import UpdateAsistenciaTablet from './menu/updateasistenciatablet.jsx'
...
export default function AsistenciasPanelTablet ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_asistencia_guardada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevaAsistenciaTablet proporcional={proporcional} asistencia={asistencia}/>
            ...
            }
            {
                show_asistencia_actualizada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '60%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateAsistenciaTablet proporcional={proporcional} asistencia={asistencia}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
