...
import CardAsistencia from './card/asistencia.jsx'
...
export default function ListaAsistencias ({proporcional}) {
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_asistencias && lista_asistencias.length > 0 ? (
                        lista_asistencias.map ((asistencia, index) => {
                            return (
                                <CardAsistencia proporcional={proporcional} key={index} index={index} asistencia={asistencia}/>
                            )
                        })
                    ) : null
                }
