...
import NuevaNomina from './menu/nuevanomina.jsx'
import UpdateNomina from './menu/updatenomina.jsx'
...
export default function NominasPanel ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_nomina_guardada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevaNomina proporcional={proporcional} nomina={nomina}/>
            ...
            }
            {
                show_nomina_actualizada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '30%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateNomina proporcional={proporcional} nomina={nomina}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
