...
import CardNominaTablet from './card/nominatablet.jsx'
...
export default function ListaNominasTablet ({proporcional}) {
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_nominas && lista_nominas.length > 0 ? (
                        lista_nominas.map ((nomina, index) => {
                            return (
                                <CardNominaTablet proporcional={proporcional} key={index} index={index} nomina={nomina}/>
                            )
                        })
                    ) : null
                }
