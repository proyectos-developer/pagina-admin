...
import NuevaNominaCell from './menu/nuevanominacell.jsx'
import UpdateNominaCell from './menu/updatenominacell.jsx'
...
export default function NominasPanelCell ({proporcional}) {
        ...
        <div className='position-relative' style={{width: '100%', height: '100%'}}>
            {
                show_nomina_guardada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        ...
                        <NuevaNominaCell proporcional={proporcional} nomina={nomina}/>
            ...
            }
            {
                show_nomina_actualizada ? (
                    <div className='position-fixed end-0 top-50 shadow overflow-auto' 
                        style={{width: '90%', height: 'auto', background: 'white', zIndex: 9999}}>
                        <UpdateNominaCell proporcional={proporcional} nomina={nomina}/>
                        <div className='d-flex justify-content-center' style={{width: '100%', height: 'auto', padding: 20 / proporcional}}>
