...
import CardNomina from './card/nomina.jsx'
...
export default function ListaNominas ({proporcional}) {
            ...
            <div style={{width: '100%', minHeight: 500 / proporcional}}>
                {
                    lista_nominas && lista_nominas.length > 0 ? (
                        lista_nominas.map ((nomina, index) => {
                            return (
                                <CardNomina proporcional={proporcional} key={index} index={index} nomina={nomina}/>
                            )
                        })
                    ) : null
                }
