...
export default function NuevaNominaTablet ({proporcional}) {
                    ...
                    nombres !== '' ? (
                        <div className='' style={{width: '100%', height: 'auto'}}>
                            ...
                            autoComplete={false}
                                                    ...
                                                    type='default'
                                                    id='fecha_pago'
                                                    value={fecha_pago ? fecha_pago.toDateString() : ''}
                                                    className='form-control rounded border-0'
                                                    onChange={(event) => setFechaPago(event.target.value)}
                                                    style={{width: '48%', height: 40 / proporcional, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                                                            fontFamily: 'Poppins, sans-serif',
                                                            padding: 10 / proporcional, background: 'white'}}
                                                    placeholder='Buscar por nombre, código, dni...'/>
                                                <div className='d-flex justify-content-end' style={{width: '48%', height: 40 / proporcional}}
                                                    onClick={() => setCambiarFechaPago(true)}>
                                                    <p  style={{lineHeight: `${40 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                                                            ...
                                                            paddingRight: 12.5 / proporcional}}>Cambiar fecha</p>
                                                </div>
                                            </div>
                                        </div>  
                                    ) : (
                            ...
                            <div className='' style={{width: '32%', height: 40 / proporcional, marginBottom: 16 / proporcional}}>
                                <p  style={{lineHeight: `${25 / proporcional}px`, fontSize: 16 / proporcional, color: 'rgb(89, 89, 89)',
                                        fontFamily: 'Poppins, sans-serif', marginBottom: 0, background: 'white', cursor: 'pointer',
